        ...
        (function (n) {
            ...
            a.a.K = new (function () {
                ...
                return {
                    ...
                    yb: function (c, d) {
                        var f = b(c, !1);
                        f &&
                            (a.a.Pa(f, d), 0 == f.length && a.a.g.set(c, e, n));
                    },
                    oa: function (b) {
                        a.u.G(function () {
                            f[b.nodeType] &&
            ...
            var D = {
                ...
                notifySubscribers: function (b, c) {
                    ...
                    if (this.Wa(c)) {
                        var d =
                            ("change" === c && this.ed) || this.U[c].slice(0);
                        try {
                            a.u.xc();
                ...
                ub: function (b) {
                    var c = this,
                        ...
                        m;
                    c.gb ||
                        ((c.gb = c.notifySubscribers),
                        (c.notifySubscribers = Z));
                    var k = b(function () {
                        c.Ja = !1;
                        d && h === c && (h = c.nc ? c.nc() : c());
                        var a = f || (m && c.sb(g, h));
                ...
                sb: function (a, c) {
                    return (
                        !this.equalityComparer || !this.equalityComparer(a, c)
                    );
                },
                toString: function () {
                ...
                function d() {
                    function c() {
                        if (m) {
                            ...
                            e &&
                                e.length &&
                                b.notifySubscribers(e, "arrayChange");
                        }
                    }
                    e
                        ? c()
            ...
            (function () {
                ...
                var f =
                        w &&
                        "\x3c!--test--\x3e" === w.createComment("test").text,
                    g = f
                ...
                a.h = {
                    ...
                    firstChild: function (a) {
                        ...
                        if (a.firstChild && c(a.firstChild))
                            throw Error(
                                "Found invalid end comment, as the first child of " +
                                    a
                            );
                        return a.firstChild;
                    },
            ...
            (function (b) {
                function c(c, e) {
                    var k = Object.prototype.hasOwnProperty.call(f, c)
                            ? f[c]
                            : b,
                        l;
                    k
            ...
            (function () {
                ...
                function d(b) {
                    switch (a.a.R(b)) {
                        ...
                        case "template":
                            if (e(b.content))
                                return a.a.Ca(b.content.childNodes);
                    }
                ...
                a.j.register = function (b, c) {
                    ...
                    if (a.j.tb(b))
                        throw Error(
                            "Component " + b + " is already registered"
                        );
                    h[b] = c;
                };
                a.j.tb = function (a) {
                    ...
                    loadTemplate: function (b, c, f) {
                        ...
                        if ("string" === typeof c) f(a.a.ua(c));
                            ...
                            if (
                                ...
                                h
                                    ? f(d(h))
                                    : b("Cannot find element with ID " + c);
                ...
                a.Qd = function (b, d, g, h, m) {
                    ...
                    var v,
                        ...
                        w =
                            ...
                            (a.options.foreachHidesDestroyed &&
                                !g.includeDestroyed);
                ...
                a.$a = function () {
                    var a = (this.Hd = (function () {
                        ...
                        try {
                            if (
                                0 <=
                                v.tmpl.tag.tmpl.open.toString().indexOf("__")
                            )
                                return 2;
                        } catch (a) {}
                        return 1;
