...
!(function (e, a) {
    "object" == typeof exports && "object" == typeof module
        ? (module.exports = a(require("survey-creator-core")))
        : "function" == typeof define && define.amd
        ? define("SurveyCreatorLocales", ["survey-creator-core"], a)
        : "object" == typeof exports
        ? (exports.SurveyCreatorLocales = a(require("survey-creator-core")))
        : (e.SurveyCreatorLocales = a(e.SurveyCreatorCore));
})(this, function (e) {
    return (function (e) {
        var a = {};
        function t(i) {
            if (a[i]) return a[i].exports;
            var o = (a[i] = { i: i, l: !1, exports: {} });
        ...
        function (e, a, t) {
            ...
            t.r(a);
            var i = t(0);
            i.editorLocalization.locales.ar = {
                survey: {
                    edit: "تعديل",
                ...
                ed: {
                    ...
                    panelPlaceHolder:
                        "قم بإسقاط السؤال من صندوق الأدوات إلى هنا",
                    ...
                    lg: {
                        ...
                        itemExpressionText:
                            "عندما التعبير '{0}' رجع قيمة المنطقية صحيح",
                        ...
                        expressionInvalid:
                            "التعبير المنطقي الرياضي فارغ أو غير صحيح، يرجى تصحيحه",
                        noActionError: "الرجاء، إضافة إجراء واحد على الأقل",
                        actionInvalid:
                            "الرجاء، إصلاح الأخطاء في الإجراء التابع لك",
                    },
                },
                pe: {
                    apply: "تطبيق",
                    ...
                    cookieName:
                        "أدخل إسم ملف تعريف الإرتباط (لتعطيل المشاركة بالإستبيان أكثر من مرة)",
                    sendResultOnPageNext:
                        "إرسال نتائج الإستبيان على الصفحة التالية",
                    ...
                    showNavigationButtons:
                        "إظهار أزرار الإنتقال (التنقل الإفتراضي)",
                    showPrevButton:
                        "إظهار زر التنقل السابق (السماح للمستخدم من العودة للصفحة السابقة في الإستبيان)",
                    firstPageIsStarted:
                        "الصفحة الأولى في الإستبيان هي صفحة البدء",
                    showCompletedPage:
                        "إظهار الصفحة المكتملة في النهاية (صفحة ويب مكتملة)",
                    goNextPageAutomatic:
                        "عند الإجابة على جميع الأسئلة، إنتقل إلى الصفحة التالية تلقائياً",
                    ...
                    focusFirstQuestionAutomatic:
                        "ركز المؤشر على السؤال الأول عند تغير الصفحة",
            ...
            i.editorLocalization.locales.hr = {
                survey: {
                    edit: "Uređivanje",
                    externalHelpLink:
                        "Gledajte i saznajte kako stvoriti ankete",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion: "Molimo ispustite pitanje ovdje iz Toolbox.",
                    addLogicItem:
                        "Izradite pravilo za prilagodbu tijeka ankete.",
                    copy: "Kopirati",
                    duplicate: "Duplikata",
                ...
                ed: {
                    ...
                    translationNoStrings:
                        "Nema žica za prevođenje. Promijenite filtar.",
                    ...
                    lg: {
                        ...
                        trigger_runExpressionName:
                            "Pokretanje prilagođenog izraza",
                        completedHtmlOnConditionName:
                            "Prilagođeni 'Thank you page' tekst",
                        page_visibilityDescription:
                        ...
                        question_visibilityText:
                            "Učinite pitanje {0} vidljivim",
                        ...
                        trigger_setvalueText:
                            "Postavljeno u pitanje: {0} vrijednost {1}",
                        trigger_copyvalueText:
                            "Kopirajte u pitanje: {0} vrijednost od pitanja {1}",
                        trigger_skipText: "Anketa preskače na pitanje {0}",
                        trigger_runExpressionText1: "Pokretanje izraza: '{0}'",
                        trigger_runExpressionText2:
                            " i dovela u pitanje svoj rezultat: {0}",
                        completedHtmlOnConditionText:
                ...
                pe: {
                    ...
                    cellsEmptyRowsColumns:
                        "Trebao bi postojati barem jedan stupac ili red",
                    ...
                    choicesMin:
                        "Minimalna vrijednost za automatski generirane stavke",
                    choicesMax:
                        "Maksimalna vrijednost za automatski generirane stavke",
                    ...
                    storeDataAsText:
                        "Pohranite sadržaj datoteke u rezultat JSON kao tekst",
                    ...
                    cookieName:
                        "Naziv kolačića (onemogućiti anketu dva puta lokalno)",
                    sendResultOnPageNext:
                        "Pošaljite rezultate ankete na sljedeću stranicu",
                    storeOthersAsComment:
                        "Pohranite vrijednost 'others' u zasebnom polju",
                    ...
                    showNavigationButtons:
                        "Prikakanje navigacijskih tipki (zadana navigacija)",
                    showPrevButton:
                        "Prikagnite prethodni gumb (korisnik se može vratiti na prethodnu stranicu)",
                    firstPageIsStarted:
                        "Prva stranica u anketi je početna stranica.",
                    showCompletedPage:
                        "Prikagušite dovršenu stranicu na kraju (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Indeks pokretanja pitanja (1, 2 ili 'A', 'a')",
                    ...
                    maxTimeToFinishPage:
                        "Maksimalno vrijeme za dovršanje stranice u anketi",
                    page: {},
                    question: {},
                    ...
                    titleKeyboardAdornerTip:
                        "Pritisnite gumb za unos za uređivanje",
                    keyboardAdornerTip:
                    ...
                    triggerIsVariable:
                        "Ne stavljajte varijablu u rezultat ankete.",
                ...
                pv: {
                    ...
                    showAnsweredQuestions:
                        "show preview with answered questions",
                    showNavigationButtons: {},
                    showProgressBar: {},
                    showTimerPanel: {},
                    showTimerPanelMode: {},
            ...
            i.editorLocalization.locales.cs = {
                survey: {
                    edit: "Upravit",
                    externalHelpLink:
                        "Podívejte se a naučte se vytvářet průzkumy",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion: "Sem napište otázku ze sady nástrojů.",
                    addLogicItem:
                        "Vytvořte pravidlo pro přizpůsobení průběhu průzkumu.",
                    copy: "Kopírovat",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        completedHtmlOnConditionName:
                            "Vlastní text stránky s poděkováním",
                        page_visibilityDescription:
                            "Zobrazení stránky, když se logický výraz vrátí jako true. V opačném případě zůstane neviditelná.",
                        panel_visibilityDescription:
                            "Zobrazení panel, když se logický výraz vrátí jako true. V opačném případě zůstane neviditelný.",
                        panel_enableDescription:
                            "Panel a všechny prvky v něm se aktivují, když logický výraz vrátí hodnotu true. V opačném případě je nechte vypnuté.",
                        question_visibilityDescription:
                            "Zobrazit otázku, když logický výraz vrátí hodnotu true. V opačném případě zůstane neviditelná.",
                        question_enableDescription:
                            "Povolit otázku, když logický výraz vrátí hodnotu true. V opačném případě zůstane neviditelná.",
                        question_requireDescription:
                            "Otázka se stává povinnou, když logický výraz vrátí hodnotu true.",
                        trigger_completeDescription:
                            "Když logický výraz vrátí hodnotu true, průzkum je dokončen a koncovému uživateli se zobrazí stránka s poděkováním.",
                        trigger_setvalueDescription:
                            "Pokud se změní hodnoty otázek, které jsou použity v logickém výrazu, a logický výraz vrátí hodnotu true, nastaví se hodnota na vybranou otázku.",
                        trigger_copyvalueDescription:
                            "Pokud se změní hodnoty otázek, které jsou použity v logickém výrazu, a logický výraz vrátí hodnotu true, pak se hodnota jedné vybrané otázky zkopíruje do jiné vybrané otázky.",
                        trigger_skipDescription:
                            "Pokud logický výraz vrátí hodnotu true, průzkum přejde na vybranou otázku/zaměří se na ni.",
                        trigger_runExpressionDescription:
                            "Pokud logický výraz vrátí hodnotu true, provede se vlastní výraz. Výsledek tohoto výrazu můžete volitelně nastavit do vybrané otázky.",
                        completedHtmlOnConditionDescription:
                            "Pokud logický výraz vrátí hodnotu true, změní se výchozí text stránky s poděkováním na zadaný text.",
                        itemExpressionText:
                            "Pokud výraz „{0}“ vrátí hodnotu true:",
                        ...
                        trigger_copyvalueText:
                            "Kopírovat do otázky: {0} hodnota z otázky {1}",
                        trigger_skipText: "Průzkum přeskočí na otázku {0}",
                        trigger_runExpressionText1: "Spustit výraz: „{0}“",
                        trigger_runExpressionText2:
                            " a zpochybnit jeho výsledek: {0}",
                        completedHtmlOnConditionText:
                            "Zobrazit vlastní text pro stránku s poděkováním.",
                        conditions: "Podmínky",
                        actions: "Akce",
                        ...
                        selectedActionCaption:
                            "Vyberte akci, kterou chcete přidat...",
                        expressionInvalid:
                            "Logický výraz je prázdný nebo neplatný. Opravte jej.",
                ...
                pe: {
                    ...
                    expressionHelp:
                        "Pro přístup k hodnotám otázek můžete použít složené závorky: {otázka1} + {otázka2}, ({cena}*{množství}) * (100 - {sleva}). Můžete použít funkce jako: iif(), today(), age(), min(), max(), count(), avg() a další.",
                    aceEditorHelp:
                        "Stisknutím kláves ctrl+mezerník získáte nápovědu k dokončení výrazu",
                    ...
                    cellsEmptyRowsColumns:
                        "Měl by existovat alespoň jeden sloupec nebo řádek.",
                    ...
                    choicesMin:
                        "Minimální hodnota pro automaticky generované položky",
                    choicesMax:
                        "Maximální hodnota pro automaticky generované položky",
                    choicesStep:
                        "Rozdíl mezi automaticky generovanými položkami",
                    name: "Název",
                    title: "Titul",
                    cellType: "Typ buňky",
                    ...
                    storeDataAsText:
                        "Uložit obsah souboru ve výsledku JSON jako text",
                    ...
                    cookieName:
                        "Název souboru cookie (pro zakázání dvojího lokálního spuštění průzkumu)",
                    sendResultOnPageNext:
                        "Odeslání výsledků průzkumu na další straně",
                    storeOthersAsComment:
                        "Uložení hodnoty „others“ do samostatného pole",
                    ...
                    showNavigationButtons:
                        "Zobrazit navigační tlačítka (výchozí navigace)",
                    showPrevButton:
                        "Zobrazit předchozí tlačítko (uživatel se může vrátit na předchozí stránku)",
                    firstPageIsStarted:
                        "První stránka průzkumu je úvodní stránka.",
                    showCompletedPage:
                        "Zobrazení dokončené stránky na konci (completedHtml)",
                    goNextPageAutomatic:
                        "Po zodpovězení všech otázek automaticky přejít na další stránku",
                    ...
                    questionTitleTemplate:
                        "Šablona názvu otázky, výchozí je: „{no}. {require} {title}“",
                    questionErrorLocation: "Umístění chyby v otázce",
                    focusFirstQuestionAutomatic:
                        "Zaměřte se na první otázku týkající se změny stránky",
                    questionsOrder: "Pořadí prvků na stránce",
                    maxTimeToFinish: "Maximální doba pro dokončení průzkumu",
                    maxTimeToFinishPage:
                        "Maximální doba pro dokončení stránky v průzkumu",
                    page: {},
                    question: {},
                    ...
                    keyboardAdornerTip:
                        "Stisknutím klávesy enter upravíte položku, stisknutím klávesy delete položku odstraníte, stisknutím klávesy alt plus šipky nahoru nebo šipky dolů položku přesunete.",
                    triggerOn: "Zapnout ",
                    triggerMakePagesVisible: "Zobrazit stránky:",
                    triggerMakeQuestionsVisible: "Zobrazit prvky:",
                    triggerCompleteText:
                        "Vyplňte průzkum, pokud se vám to podaří.",
                    ...
                    triggerIsVariable:
                        "Nevkládejte proměnnou do výsledku průzkumu.",
                ...
                pv: {
                    ...
                    showAnsweredQuestions:
                        "zobrazit náhled se zodpovězenými otázkami",
                    pages: "stránky",
                    questions: "otázky",
            ...
            i.editorLocalization.locales.da = {
                survey: {
                    edit: "Rediger",
                    dropQuestion:
                        "Træk et spørgsmål hertil fra paletten til venstre.",
                    copy: "Kopier",
                ...
                pe: {
                    ...
                    aceEditorHelp:
                        "Tast ctrl+space for hjælp til at afslutte udtrykket",
                    ...
                    cellsEmptyRowsColumns:
                        "Der skal være mindst én kolonne eller række",
                    ...
                    cookieName:
                        "Cookienavn (for at undgå at afvikle undersøgelsen to gange lokalt)",
                    sendResultOnPageNext:
                        "Send undersøgelsesresultatet ved næste side",
                    storeOthersAsComment:
                        "Gem 'others' værdien i et seperat felt",
                    ...
                    showNavigationButtons:
                        "Vis navigationsknapper (standard navigation)",
                    showPrevButton:
                        "Vis forrige knap (brugeren må gå tilbage til forrige side)",
                    firstPageIsStarted:
                        "Den første side in undersøgelsen er starten på undersøgelsen.",
                    showCompletedPage:
                        "Vis afslutningssiden til slut (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Spørgsmål startindex (1, 2 eller 'A', 'a')",
                    ...
                    focusFirstQuestionAutomatic:
                        "Fokusér første spørgsmål ved sideskift",
                    questionsOrder: "Rækkefølge af spørgsmål på siden",
                    maxTimeToFinish:
                        "Maximal tid til at gennemføre undersøgelsen",
                    maxTimeToFinishPage:
                        "Maximal tid til at gennemføre en side i undersøgelsen",
                    page: {},
                    question: {},
                    ...
                    triggerCompleteText:
                        "Aflslut spørgeskema ved at fortsætte.",
                    ...
                    triggerSetValue: "til: ",
                    triggerIsVariable:
                        "Gem ikke variablen i undersøgelsesresultatet.",
                },
                pv: {
                    inherit: "inherit",
                    show: "show",
                ...
                ts: { selectPage: "Vælg siden for at teste den:" },
                validators: {
                    answercountvalidator: "answer count",
                    emailvalidator: "e-mail",
                    expressionvalidator: "expression",
            ...
            i.editorLocalization.locales.nl = {
                survey: {
                    edit: "Bewerk",
                    ...
                    addLogicItem:
                        "Maak een regel om de stroom van de enquête aan te passen.",
                    copy: "Kopiëren",
                ...
                ed: {
                    ...
                    saveError:
                        "Fout! De inhoud van de editor wordt niet opgeslagen.",
                    ...
                    translationNoStrings:
                        "Geen verplichtingen om te vertalen. Vervang alstublieft het filter.",
                    translationExportToSCVButton: "Exporteren naar CSV",
                    translationImportFromSCVButton: "Importeren vanuit CSV",
                    translationMergeLocaleWithDefault:
                        "Voeg {0} samen met de standaardlandinstelling",
                    bold: "Vetgedrukt",
                    italic: "Cursief",
                    ...
                    lg: {
                        ...
                        trigger_runExpressionName:
                            "Voer een aangepaste expressie uit",
                        completedHtmlOnConditionName:
                            "Aangepaste 'Bedanktpagina'-tekst",
                        page_visibilityDescription:
                        ...
                        itemExpressionText:
                            "Wanneer expressie: '{0}' true retourneert:",
                        ...
                        trigger_copyvalueText:
                            "Kopieer naar vraag: {0} waarde uit vraag {1}",
                        trigger_skipText: "Enquête ga verder met de vraag {0}",
                        trigger_runExpressionText1:
                            "Uitdrukking uitvoeren: '{0}'",
                        trigger_runExpressionText2:
                            " en stel het resultaat in vraag: {0}",
                        completedHtmlOnConditionText:
                        ...
                        selectedActionCaption:
                            "Selecteer een actie om toe te voegen...",
                        expressionInvalid:
                ...
                pe: {
                    ...
                    aceEditorHelp:
                        "Druk op Ctrl+spatiebalk om een hint voor het voltooien van een uitdrukking te krijgen",
                    ...
                    cellsEmptyRowsColumns:
                        "Er moet minimaal één kolom of rij zijn",
                    showPreviewBeforeComplete:
                        "Voorbeeldweergave voor afronden",
                    ...
                    surveyDescriptionPlaceholder:
                        "Voer een onderzoeksbeschrijving in",
                    pageDescriptionPlaceholder:
                        "Voer een paginabeschrijving in",
                    ...
                    choicesMin:
                        "Minimumwaarde voor automatisch gegenereerde items",
                    choicesMax:
                        "Maximale waarde voor automatisch gegenereerde items",
                    choicesStep:
                        "Het verschil tussen automatisch gegenereerde items",
                    name: "Naam",
                    title: "Titel",
                    cellType: "Celtype",
                    ...
                    requiredErrorText:
                        "Tekst bij niet-ingevulde verplichte vraag",
                    ...
                    storeDataAsText:
                        "Bewaar bestandsinhoud in JSON-resultaat als tekst",
                    ...
                    cookieName:
                        "Cookienaam (zodat enquête slechts éénmalig wordt ingevuld)",
                    sendResultOnPageNext:
                        "Antwoorden opslaan bij pagina-overgang",
                    storeOthersAsComment:
                        "Sla de waarde van 'anderen' op in een apart veld",
                    ...
                    showNavigationButtons:
                        "Navigatieknoppen weergeven (standaardnavigatie)",
                    showPrevButton:
                        "Toon knop 'Vorige pagina' (gebruiker kan terugkeren)",
                    firstPageIsStarted:
                        "De eerste pagina in de enquête is een startpagina",
                    ...
                    focusFirstQuestionAutomatic:
                        "Op volgende pagina focus op de eerste vraag zetten",
                    questionsOrder: "Volgorde elementen op pagina",
                    maxTimeToFinish: "Maximale tijd om de enquête te voltooien",
                    maxTimeToFinishPage:
                        "Maximale tijd om een pagina in de enquête te voltooien",
                    page: {},
                    question: {},
                    ...
                    titleKeyboardAdornerTip:
                        "Druk op de enter-knop om te bewerken",
                    keyboardAdornerTip:
                    ...
                    triggerIsVariable:
                        "Zet de variabele niet in het onderzoeksresultaat.",
                    triggerRunExpressionEmpty:
                        "Voer een geldige uitdrukking in",
                ...
                pv: {
                    ...
                    showAnsweredQuestions:
                        "Toon voorbeeld met beantwoorde vragen",
            ...
            i.editorLocalization.locales.fi = {
                survey: {
                    edit: "Muokkaa",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        completedHtmlOnConditionDescription:
                            "If the logic expression returns true, then the default text for the 'Thank you page' is changed to the given one.",
                        itemExpressionText:
                            "Kun lauseke: '{0}' palauttaa arvon tosi:",
                        ...
                        trigger_copyvalueText:
                            "Kopioi kysymykseen: {0} arvo kysymyksestä {1}",
                        trigger_skipText: "Siirry kyselyn kysymykseen {0}",
                        trigger_runExpressionText1: "Suorita lauseke: '{0}'",
                        trigger_runExpressionText2:
                            " ja aseta sen tulos kysymykseen: {0}",
                        completedHtmlOnConditionText:
                            "Näytä mukautettu teksti Kiitos -sivulle.",
                        conditions: "Ehdot",
                        actions: "Toiminnot",
                        ...
                        expressionInvalid:
                            "Looginen lauseke on tyhjä tai virheellinen. Korjaa se.",
                ...
                pe: {
                    ...
                    expressionHelp:
                        "Voit käyttää aalto ​​sulkeita päästäksesi kysymysarvoihin: {question1} + {question2}, ({price}*{quantity}) * (100 - {discount}). Voit käyttää funktioita: iif(), today(), age(), min(), max(), count(), avg() ja muita.",
                    aceEditorHelp:
                        "Paina ctrl + välilyönti saadaksesi lausekkeen täydennysvihje",
                    ...
                    cellsEmptyRowsColumns:
                        "Sarakkeita tai rivejä on oltava vähintään yksi",
                    ...
                    choicesMin:
                        "Automaattisesti luotujen valintojen vähimmäisarvo",
                    choicesMax:
                        "Automaattisesti luotujen valintojen enimmäisarvo",
                    ...
                    storeDataAsText:
                        "Tallenna tiedostosisältö JSON-tulokseen tekstinä",
                    ...
                    cookieName:
                        "Evästeen nimi (poistaaksesi kysely käytöstä suorita kysely kaksi kertaa paikallisesti)",
                    sendResultOnPageNext:
                        "Lähetä kyselyn tulokset seuraavalla sivulla",
                    storeOthersAsComment:
                        "Tallenna 'muut' arvo erilliseen kenttään",
                    ...
                    showNavigationButtons:
                        "Näytä navigointipainikkeet (oletusnavigointi)",
                    showPrevButton:
                        "Näytä edellinen -painike (käyttäjä voi palata edelliselle sivulle)",
                    firstPageIsStarted:
                        "Kyselyn ensimmäinen sivu on aloitussivu.",
                    showCompletedPage:
                        "Näytä valmis sivu lopussa (completeHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Kysymyksen aloitus indeksi (1, 2 or 'A', 'a')",
                    ...
                    titleKeyboardAdornerTip:
                        "Paina Enter -painiketta muokataksesi",
                    keyboardAdornerTip:
                        "Voit muokata kohdetta painamalla Enter -painiketta, poistaa kohteen painamalla poistopainiketta, siirtää kohdetta painamalla Alt plus nuoli ylös tai nuoli alas",
                    triggerOn: "Päällä ",
                    triggerMakePagesVisible: "Tee sivuista näkyviä:",
                    triggerMakeQuestionsVisible: "Tee elementit näkyviksi:",
                    triggerCompleteText:
                        "Valmista kysely, jos se on onnistunut.",
            ...
            i.editorLocalization.locales.fr = {
                survey: {
                    edit: "Éditer",
                ...
                ed: {
                    ...
                    saved: "Sauvegardé",
                    saveError:
                        "Erreur! Le contenu de l'éditeur n'a pas été sauvegardé.",
                    ...
                    translationMergeLocaleWithDefault:
                        "Fusionner {0} avec langue par défaut",
                    bold: "Gras",
                    italic: "Italique",
                    underline: "Souligné",
                    addNewQuestion: "Ajouter {0}",
                    surveyPlaceHolder:
                        "L' enquête est vide. Faites glisser un élément de la boîte à outils ou cliquez sur le bouton ci-dessous.",
                    lg: {
                        ...
                        trigger_copyvalueName:
                            "Copier la valeur de la question",
                        trigger_skipName: "Passer à la question",
                        trigger_runExpressionName:
                            "Exécuter une expression personnalisée",
                        completedHtmlOnConditionName:
                        ...
                        itemExpressionText:
                            "Lorsque l'expression: '{0}' renvoie 'vrai':",
                        ...
                        question_visibilityText:
                            "Rendre la question {0} visible",
                        question_enableText: "Activer la question {0}",
                        question_requireText:
                            "Rendre la question {0} obligatoire",
                        trigger_completeText:
                            "Le questionnaire devient complété.",
                        trigger_setvalueText:
                            "Définir dans la question: {0} valeur {1}",
                        trigger_copyvalueText:
                            "Copier dans la question: {0} valeur de la question {1}",
                        trigger_skipText:
                            "Dans le questionnaire, passez à la question {0}",
                        trigger_runExpressionText1:
                            "Exécuter l'expression: '{0}'",
                        trigger_runExpressionText2:
                            " et définissez son résultat dans la question: {0}",
                        completedHtmlOnConditionText:
                ...
                pe: {
                    ...
                    conditionValueQuestionTitle:
                        "Sélectionner ou saisir la valeur",
                    expressionHelp:
                    ...
                    cellsEmptyRowsColumns:
                        "Il faut au minimum une ligne ou une colonne",
                    propertyIsEmpty:
                        "Veuillez entrer une valeur pour la propriété",
                    ...
                    surveyDescriptionPlaceholder:
                        "Entrer une description pour l'enquête",
                    pageDescriptionPlaceholder:
                        "Entrer une description pour la page",
                    ...
                    choicesMin:
                        "Valeur minimum pour les items générés automatiquement",
                    choicesMax:
                        "Valeur maximum pour les items générés automatiquement",
                    choicesStep:
                        "Différence entre items générés automatiquement",
                    name: "Nom",
                    title: "Titre",
                    ...
                    isAllRowRequired:
                        "Réponse obligatoire pour toutes les lignes",
                    ...
                    surveyEditorTitle:
                        "Éditer les préférences du questionnaire",
                    ...
                    sendResultOnPageNext:
                        "Envoyer les résultats au changement de page",
                    storeOthersAsComment:
                        'Sauvegarder la valeur "Autres" dans un champ séparé',
                    ...
                    isSinglePage:
                        "Afficher tous les éléments sur une seule page",
                    expression: "Expression",
                    ...
                    noquestions:
                        "Il n'y a aucune question dans le questionnaire.",
                    createtrigger: "Veuillez créer un déclencheur",
                    triggerOn: "Quand ",
                    triggerMakePagesVisible: "Rendre les pages visibles :",
                    triggerMakeQuestionsVisible:
                        "Rendre les questions visibles :",
                    triggerCompleteText:
                        "Terminer le questionnaire en cas de succès.",
                    ...
                    triggerRunExpressionEmpty:
                        "Veuillez entrer une expression valide",
                },
                pv: {
                    inherit: "hérité",
                    show: "afficher",
                ...
                ew: {
                    ...
                    loadFromServer:
                        "Charger le JSON du questionnaire depuis un serveur",
            ...
            i.editorLocalization.locales.de = {
                survey: {
                    edit: "Bearbeiten",
                    externalHelpLink:
                        "Schauen Sie sich an, wie Sie Umfragen erstellen können",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion: "Frage bitte hier platzieren.",
                    addLogicItem:
                        "Eine Regel erstellen, um den Fluss der Umfrage anzupassen.",
                    copy: "Kopieren",
                ...
                ed: {
                    ...
                    saveError:
                        "Fehler! Der Inhalt des Editors wurde nicht gespeichert.",
                    ...
                    panelPlaceHolder:
                        "Ziehe eine Frage aus der Toolbox hier her.",
                    surveyPlaceHolder:
                        "Die Umfrage enthält keine Frage. Ziehe ein Element aus der Toolbox hier her oder drücke den Button unten.",
                    addNewTypeQuestion: "Add {0}",
                    ...
                    lg: {
                        ...
                        empty_tab:
                            "Erstelle eine Regel erstellen, um den Fluss der Umfrage anzupassen.",
                        ...
                        itemExpressionText:
                            "Wenn der Ausdruck '{0}' wahr ergibt:",
                        ...
                        question_requireText:
                            "Mache die Frage {0} erforderlich",
                        column_visibilityText:
                            "Mache die Spalte {0} von Frage {1} sichtbar",
                        column_enableText:
                            "Aktiviere die Spalte {0} von Frage {1}",
                        column_requireText:
                            "Mache die Spalte {0} von Frage {1} erforderlich",
                        trigger_completeText: "Umfrage abschließen",
                        trigger_setvalueText:
                            "Setze in Frage {0} den Wert {1} ein",
                        trigger_copyvalueText:
                            "Kopiere in Frage {0} den Wert von Frage {1}",
                        trigger_skipText: "Gehe zu Frage {0}",
                        trigger_runExpressionText1:
                            "Führe folgenden Ausdruck aus: '{0}'",
                        trigger_runExpressionText2:
                            " und setze das Ergebnis in Frage {0} ein",
                        completedHtmlOnConditionText:
                        ...
                        selectedActionCaption:
                            "Aktion zum Hinzufügen auswählen...",
                        expressionInvalid:
                ...
                pe: {
                    ...
                    fastEntryPlaceholder:
                        "Daten im folgenden Format setzen:\nwert1|text\nwert2",
                    ...
                    conditionValueQuestionTitle:
                        "Bitte den Wert eingeben oder auswählen",
                    expressionHelp:
                    ...
                    showPreviewBeforeComplete:
                        "Vorschau der Antworten vor dem Absenden anzeigen",
                    propertyIsEmpty: "Bitte geben Sie einen Wert ein",
                    propertyIsNoUnique:
                        "Bitte geben Sie einen eindeutigen Wert ein",
                    propertyNameIsNotUnique:
                        "Bitte geben Sie einen eindeutigen Wert ein",
                    listIsEmpty: "Neues Element hinzufügen",
                    "listIsEmpty@choices":
                        "Bisher wurden noch keine Auswahlmöglichkeiten hinzugefügt",
                    ...
                    choicesMin:
                        "Minimaler Wert für automatisch erzeugte Elemente",
                    choicesMax:
                        "Maximaler Wert für automatisch erzeugte Elemente",
                    choicesStep:
                        "Schrittgröße für automatisch erzeugte Elemente",
                    name: "Name",
                    title: "Titel",
                    cellType: "Zellentyp",
                    ...
                    isAllRowRequired:
                        "Ist eine Antwort für alle Zeilen erforderlich?",
                    requiredErrorText:
                    ...
                    storeDataAsText:
                        "Speicher Dateininhalt des JSON-Resultats als Text",
                    ...
                    emptyLogicPopupMessage:
                        "Eine Frage auswählen um die Bedingungen festzulegen.",
                    if: "Wenn",
                    then: "dann",
                    setToName: "von",
                    fromName: "bis",
                    ...
                    storeOthersAsComment:
                        "Speichere andere Werte als Kommentar",
                    ...
                    firstPageIsStarted:
                        "Die erste Seite der Umfrage ist die Startseite",
                    showCompletedPage:
                        "Nach Abschluss die ausgefüllte Umfrage anzeigen",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        'Startindex der Fragen (bspw. "1", "A", "a", ...)',
                    ...
                    page: {
                        maxTimeToFinish:
                            "Zeitlimit zum Beenden der Seite (in Sekunden)",
                    },
                    question: { page: "Elternseite" },
                    ...
                    responsiveImageSizeHelp:
                        "Gilt nicht, wenn Sie die genaue Bildbreite oder -höhe angeben.",
                    ...
                    autoGrowComment:
                        "Kommentarbereich bei Bedarf automatisch erweitern",
                    ...
                    completedBeforeHtml:
                        "Markup, um anzuzeigen, ob der Benutzer diese Umfrage bereits ausgefüllt hat",
                    completedHtml: "Markup der Seite „Umfrage abgeschlossen“.",
                    completedHtmlOnCondition:
                        "Dynamisches Markup der Seite „Umfrage abgeschlossen“.",
                    loadingHtml:
                        "Markup, das angezeigt werden soll, während die Umfrage geladen wird",
                    ...
                    panelPrevText:
                        "Tooltip für die Schaltfläche „Vorheriges Bedienfeld“.",
                    panelNextText:
                        "Tooltip für die Schaltfläche „Nächstes Bedienfeld“.",
                    showRangeInProgress: "Fortschrittsbalken anzeigen",
                    separateSpecialChoices:
                        "Spezielle Auswahlmöglichkeiten separieren",
                    displayRateDescriptionsAsExtremeItems:
                        "Beschreibung für minimale und maximale Bewertung als Werte anzeigen",
                    itemvalue: {},
                    ...
                    items: "Eiträge",
                    choicesVisibleIf:
                        "Auswahlmöglichkeiten sind sichtbar, wenn",
                    ...
                    panel: { indent: "Äußere Einzüge hinzufügen" },
                    innerIndent: "Fügen Sie innere Einzüge hinzu",
                    defaultValueFromLastRow:
                        "Nehmen Sie Standardwerte aus der letzten Zeile",
                    defaultValueFromLastPanel:
                        "Nehmen Sie Standardwerte aus dem letzten Bereich",
                    ...
                    titleKeyboardAdornerTip:
                        "Bitte drücken Sie ENTER, um bearbeiten zu können",
                    keyboardAdornerTip:
                    ...
                    triggerIsVariable:
                        "Die Variable nicht in das Umfrageergebnis platzieren.",
                    triggerRunExpressionEmpty:
                        "Bitte geben Sie einen gültigen Ausdruck ein",
                    emptyExpressionPlaceHolder:
                        "Tippen Sie hier Ihren Ausdruck ein ...",
                    noFile: "Keine Datei ausgewählt",
                    clearIfInvisible:
                        "Löschen Sie den Wert, wenn die Frage ausgeblendet wird",
                ...
                pv: {
                    ...
                    onHiddenContainer:
                        "Wenn die Frage oder ihr Panel/Seite ausgeblendet wird",
                    clearInvisibleValues: { none: "Niemals" },
                    all: "alle",
                    page: "Seite",
                    survey: "Umfrage",
                    ...
                    showAnsweredQuestions:
                        "Vorschau mit beantworteten Fragen anzeigen",
                    pages: "Seiten",
                    questions: "Fragen",
                    ...
                    showNavigationButtons: { none: "Versteckt" },
                    showProgressBar: { off: "Versteckt" },
                    showTimerPanel: { none: "Versteckt" },
                    showTimerPanelMode: { all: "Beide" },
                    detailPanelMode: { none: "Versteckt" },
                    addRowLocation: { default: "Hängt vom Matrix Layout ab" },
                    panelsState: {},
                    widthMode: {},
                    imageFit: {},
                    contentMode: {},
                ...
                p: {
                    ...
                    visibleIf: "Sichtbar wenn ...",
                    useDisplayValuesInDynamicTexts:
                        "Verwende Anzeigewerte im Titel",
                    ...
                    detailPanelShowOnAdding:
                        "Panel für Details beim Hinzufügen anzeigen",
                    ...
                    questionDescriptionLocation:
                        "Position der Fragenbeschreibung",
                    ...
                    content: "Inhalt",
                    navigationButtonsVisibility:
                        "Sichtbarkeit der Navigationsbuttons",
            ...
            i.editorLocalization.locales.hu = {
                survey: {
                    edit: "Szerkesztés",
                    externalHelpLink:
                        "Nézze meg, hogyan kell kérdőíveket készíteni.",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion:
                        "Kérem dobjon ide egy kérdést a bal oldali menüből.",
                    copy: "Másolás",
                ...
                pe: {
                    ...
                    conditionValueQuestionTitle:
                        "Kérem adjon meg, vagy válasszon értéket",
                    expressionHelp:
                    ...
                    aceEditorHelp:
                        "Nyomja meg a ctrl+space billentyűkombinációt a kifejezés befejezésére vonatkozó segítségért.",
                    aceEditorRowTitle: "Jelenlegi sor",
                    aceEditorPanelTitle: "Jelenlegi panel",
                    showMore:
                        "További információért kérem tekintse meg a dokumentációt",
                    assistantTitle: "Elérhető kérdések:",
                    cellsEmptyRowsColumns:
                        "Legalább egy sornak vagy egy oszlopnak lennie kell",
                    ...
                    storeDataAsText:
                        "Az állomány tartalmát tárolja a JSON-ben, szövegként",
                    ...
                    cookieName:
                        "Süti megnevezése (a kérdőív csak egyszer kitölthető)",
                    sendResultOnPageNext:
                        "Kérdőív értékének küldése a következő lapra lépéskor",
                    storeOthersAsComment:
                        "Az 'egyéb' mező értékének tárolása külön mezőben",
                    ...
                    showNavigationButtons:
                        "Navigációs gombok mutatása (alapértelmezett navigáció)",
                    showPrevButton: "'Előző lap' gomb mutatása",
                    firstPageIsStarted:
                        "Az megkezdett lap a kérdőív első oldala.",
                    showCompletedPage:
                        "Befejező szöveg mutatása a kérdőív befejezésekor",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Kérdés kezdőindexe (1, 2 vagy 'A', 'a')",
                    ...
                    focusFirstQuestionAutomatic:
                        "Első kérdés automatikus kijelölése lapváltás esetén",
                    questionsOrder: "Elemek rendezése a lapon",
                    maxTimeToFinish:
                        "A kérdőív kitöltésére fordítható maximális idő",
                    maxTimeToFinishPage:
                        "Egy lap kitöltésére fordítható maximális idő",
                    page: {},
                    question: {},
                    ...
                    triggerIsVariable:
                        "Ne mentse az eredményt a kérdőív eredményébe.",
                },
                pv: {
                    inherit: "öröklött",
                    show: "mutatás",
                ...
                triggers: {
                    ...
                    visibletrigger:
                        "láthatóság megváltoztatása (már nincs használatban)",
                },
                pehelp: { choicesbyurl: {} },
                p: {
                    title: {
                    ...
                    navigationButtonsVisibility:
                        "Navigációs gombok láthatósága",
                    label: "Cimke",
                },
            };
            i.editorLocalization.locales.id = {
                survey: {
                    edit: "Ubah",
                ...
                ed: {
                    ...
                    translationMergeLocaleWithDefault:
                        "Gabungkan {0} dengan default locale",
                    bold: "Tebal",
                    italic: "Miring",
                ...
                pe: {
                    ...
                    showMore:
                        "Untuk detil selanjutnya silahkan periksa dokumentasi",
                    assistantTitle: "Pertanyaan tersedia:",
                    cellsEmptyRowsColumns:
                        "Harus ada setidaknya satu kolom atau baris",
                    ...
                    storeDataAsText:
                        "Simpan konten berkas dalam hasil JSON sebagai teks",
                    ...
                    sendResultOnPageNext:
                        "Kirim hasil survei pada halaman selanjutnya",
                    storeOthersAsComment:
                        "Simpan nilai 'lainnya' pada bidang lainnya",
                    ...
                    showNavigationButtons:
                        "Tampilkan tombol navigasi (navigasi standar)",
                    showPrevButton:
                    ...
                    showCompletedPage:
                        "Tampilkan keseluruhan halaman di akhir (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Indeks mulai pertanyaan (1, 2 atau 'A', 'a')",
                    ...
                    maxTimeToFinish:
                        "Waktu maksimum untuk menyelesaikan survei",
                    maxTimeToFinishPage:
                        "Waktu maksimum untuk menyelesaikan suatu halaman",
                    page: {},
                    question: {},
                    ...
                    triggerSetValue: "ke: ",
                    triggerIsVariable:
                        "Jangan meletakkan variabel ke hasil survey.",
                },
                pv: {
                    inherit: "inherit",
                    show: "tampilkan",
            ...
            i.editorLocalization.locales.it = {
                survey: {
                    edit: "Modifica",
                ...
                ed: {
                    ...
                    saveError:
                        "Errore! Il contenuto dell'editor non è salvato.",
                    ...
                    lg: {
                        ...
                        itemExpressionText:
                            "Quando l'espressione: '{0}' restituisce vero:",
                        ...
                        question_visibilityText:
                            "rendi la domanda {0} visibile",
                        question_enableText: "rendi la domanda {0} abilitata",
                        question_requireText:
                            "rendi la domanda {0} obbligatoria",
                        column_visibilityText:
                            "rendi la colonna {0} della domanda {1} visibile",
                        column_enableText:
                            "rendi la colonna {0} della domanda {1} abilitata",
                        column_requireText:
                            "rendi la colonna {0} della domanda {1} obbligatoria",
                        trigger_completeText:
                            "il questionario viene completato",
                        trigger_setvalueText:
                            "imposta nella domanda: {0} valore {1}",
                        trigger_copyvalueText:
                            "copia nella domanda: {0} valore dalla domanda {1}",
                        trigger_skipText: "questionario passa alla domanda {0}",
                        trigger_runExpressionText1:
                            "esegui l'espressione: '{0}'",
                        trigger_runExpressionText2:
                            " e imposta il risultato nella domanda: {0}",
                        completedHtmlOnConditionText:
                        ...
                        expressionInvalid:
                            "L'espressione logica è vuota o invalida. Correggila.",
                ...
                pe: {
                    ...
                    fastEntryChoicesCountError:
                        "Limita il numero di opzioni da {0} a {1}",
                    ...
                    cellsEmptyRowsColumns:
                        "Dovrebbe esserci almeno una colonna o riga",
                    showPreviewBeforeComplete:
                    ...
                    "listIsEmpty@choices":
                        "Non sono state ancora aggiunte scelte",
                    ...
                    imageLinkName:
                        "Ottieni gli URL delle immagini dal seguente campo JSON:",
                    ...
                    choicesMin:
                        "Valore minimo per le opzioni generate automaticamente",
                    choicesMax:
                        "Valore massimo per le opzioni generate automaticamente",
                    choicesStep:
                        "Distanza valori opzioni generate automaticamente",
                    name: "Nome",
                    title: "Titolo",
                    ...
                    storeOthersAsComment:
                        "Memorizza il valore Altro in campi separati",
                    ...
                    requiredText:
                        "Simbolo domanda obbligatoria, ad esempio (*)",
                    questionStartIndex:
                        "La domanda inizia con l'indice (1, 2 oppure 'A', 'a')",
                    ...
                    allowRowsDragAndDrop:
                        "Consenti il trascinamento delle righe",
                    responsiveImageSizeHelp:
                    ...
                    totalDisplayStyle:
                        "Stile di visualizzazione del valore Totale",
                    ...
                    maxTextLength:
                        "Lunghezza massima della risposta (in caratteri)",
                    maxOthersLength:
                        "Lunghezza massima del commento (in caratteri)",
                    autoGrowComment:
                        "Espansione automatica dell'area dei commenti, se necessaria",
                    textUpdateMode:
                        "Aggiornare il valore del testo della domanda",
                    focusOnFirstError:
                        "Imposta il focus sulla prima risposta invalida",
                    ...
                    panelRemoveButtonLocation:
                        "Posizione del tasto Rimozione Pannello",
                    hideIfRowsEmpty: "Nascondi la domanda se non ci sono righe",
                    hideColumnsIfEmpty:
                        "Nascondi le colonne se non ci sono righe",
                    rateValues: "Valori personalizzati",
                    hideIfChoicesEmpty:
                        "Nascondi la domanda se non ci sono scelte",
                    ...
                    minErrorText:
                        '"Valore inferiore al minimo" messaggio di errore',
                    maxErrorText:
                        '"Valore superiore al massimo" messaggio di errore',
                    otherErrorText: '"Commento vuoto" messaggio di errore',
                    keyDuplicationError:
                        '"Valore chiave non univoco" messaggio di errore',
                    ...
                    choicesFromQuestion:
                        "Copia le scelte dalla domanda seguente:",
                    ...
                    defaultValueFromLastRow:
                        "Prendi i valori predefiniti dall'ultima riga",
                    defaultValueFromLastPanel:
                    ...
                    titleKeyboardAdornerTip:
                        "Premi il tasto Invio per modificare",
                    keyboardAdornerTip:
                ...
                pv: {
                    ...
                    list: "Lista",
                    progressTop:
                        "Navigatore del pannello + Barra di avanzamento in alto",
                    progressBottom:
                        "Navigatore del pannello + Barra di avanzamento in basso",
                    progressTopBottom:
                    ...
                    showAnsweredQuestions:
                        "Mostra solo le domande con risposta",
                    ...
                    underRowSingle:
                        "Sotto la riga, solo un pannello è visibile",
                    ...
                    panelsState: {
                        default:
                            "Gli utenti non possono espandere o comprimere i pannelli",
                ...
                p: {
                    ...
                    visibleIf: "Visibile Se",
                    useDisplayValuesInDynamicTexts:
                        "Usa Valori di Riferimento nel titolo",
                    ...
                    detailPanelShowOnAdding:
                        "Dettaglio Mostra Pannello su Aggiunta",
                    logoFit: "Adattamento del logo",
                    pages: "Pagine",
                    triggers: "Triggers",
                    calculatedValues: "Valori calcolati",
                    questionDescriptionLocation:
                        "Posizione descrizione domanda",
            ...
            i.editorLocalization.locales.ja = {
                survey: {
                    edit: "編集",
                    ...
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion:
                        "ツールボックスからここに質問をドロップしてください。",
                    addLogicItem:
                        "アンケートの流れをカスタマイズするルールを作成します。",
                    copy: "コピー",
                    duplicate: "複製",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        completedHtmlOnConditionName:
                            "カスタムの「サンキューページ」テキスト",
                        page_visibilityDescription:
                            "論理式がtrue（真）を返した場合、ページを表示にします。それ以外の場合は、非表示にしておきます。",
                        panel_visibilityDescription:
                            "論理式がtrue（真）を返した場合、パネルを表示にします。それ以外の場合は、非表示にしておきます。",
                        panel_enableDescription:
                            "論理式がtrue（真）を返した場合、パネルとその中のすべての要素を有効にします。それ以外の場合は、無効にしておきます。",
                        question_visibilityDescription:
                            "論理式がtrue（真）を返した場合、質問を表示にします。それ以外の場合は、非表示にしておきます。",
                        question_enableDescription:
                            "論理式がtrue（真）を返した場合、質問を有効にします。それ以外の場合は、無効にしておきます。",
                        question_requireDescription:
                            "論理式がtrue（真）を返した場合、質問が必須になります。",
                        trigger_completeDescription:
                            "論理式がtrue（真）を返した場合、アンケートが完了し、エンドユーザーに「サンキューページ」が表示されます。",
                        trigger_setvalueDescription:
                            "論理式で使用される質問の値が変更され、論理式がtrue（真）を返した場合、その値は選択された質問に設定されます。",
                        trigger_copyvalueDescription:
                            "論理式で使用される質問の値が変更され、論理式がtrue（真）を返した場合、選択された1つの質問の値が別の選択された質問にコピーされます。",
                        trigger_skipDescription:
                            "論理式がtrue（真）を返した場合、アンケートは選択された質問にスキップ/フォーカスされます。",
                        trigger_runExpressionDescription:
                            "論理式がtrue（真）を返した場合、カスタム式が実行されます。オプションで、この式の結果を選択した質問に設定することができます。",
                        completedHtmlOnConditionDescription:
                            "論理式がtrue（真）を返した場合、「サンキューページ」のデフォルトテキストは指定されたものに変更されます。",
                        itemExpressionText:
                            "式：「{0}」がtrue（真）を返した場合：",
                ...
                pe: {
                    ...
                    expressionHelp:
                        "波括弧を使用して質問の値にアクセスできます: {質問1} + {質問2}, ({値段}*{数量}) * (100 - {割引})。iif(), today(), age(), min(), max(), count(), avg() およびその他の関数を使用できます。",
                    aceEditorHelp:
                        "表現の補完のヒントを取得するには「ctrl+space」を押してください",
                    aceEditorRowTitle: "現在の行",
                    aceEditorPanelTitle: "現在のパネル",
                    showMore: "詳細は文書をご確認ください",
                    assistantTitle: "利用できる質問:",
                    cellsEmptyRowsColumns:
                        "少なくとも1つの列または行を含む必要があります",
                    ...
                    cookieName:
                        "Cookie名（ローカルで2回アンケートを実行しないようにするため）",
                    sendResultOnPageNext:
                        "次のページにアンケート結果を送信する",
                    storeOthersAsComment:
                        "「その他」の値を別のフィールドに保存する",
                    ...
                    showNavigationButtons:
                        "ナビゲーションボタンを表示する（デフォルトのナビゲーション）",
                    showPrevButton:
                        "「前へ」ボタンを表示する（ユーザーは前のページに戻ることができます）",
                    firstPageIsStarted:
                        "アンケートの最初のページは、開始ページです。",
                    showCompletedPage:
                        "完了したページを最後に表示する（completedHtml）",
                    goNextPageAutomatic:
                        "すべての質問に回答すると、自動的に次のページに移動します",
                    showProgressBar: "プログレスバーを表示する",
                    questionTitleLocation: "質問のタイトルの場所",
                    requiredText: "質問には記号が必要",
                    questionStartIndex:
                        "質問開始インデックス（1、2または「A」、「a」）",
                    showQuestionNumbers: "質問番号を表示する",
                    questionTitleTemplate:
                        "質問タイトルのテンプレート、デフォルトは「{no}. {require} {title}」です",
                    questionErrorLocation: "質問エラーの場所",
                    focusFirstQuestionAutomatic:
                        "ページを変える際に最初の質問に焦点を合わせる",
                    questionsOrder: "ページ上の要素の順序",
                    maxTimeToFinish: "アンケート終了までの最長時間",
                    maxTimeToFinishPage:
                        "アンケートの1ページを終了するまでの最長時間",
                    page: {},
                    question: {},
                    ...
                    titleKeyboardAdornerTip:
                        "編集するには「enter」キーを押してください",
                    keyboardAdornerTip:
                        "アイテムを編集するには「enter」キーを押してください、アイテムを削除するには「delete」キーを押してください、アイテムを移動するには「alt」+上矢印キーまたは「alt」+下矢印キーを押してください",
                    triggerOn: "オン ",
            ...
            i.editorLocalization.locales.ko = {
                survey: {
                    edit: "편집",
                ...
                pe: {
                    ...
                    cookieName:
                        "쿠키 이름(로컬에서 설문 조사를 두 번 사용하지 않도록 설정)",
                    sendResultOnPageNext:
                        "다음 페이지에서 설문 조사 결과 보내기",
                    storeOthersAsComment:
                        "다른 사용자의 값을 별도의 필드에 저장",
                    ...
                    showPrevButton:
                        "이전 버튼 표시 (사용자가 이전 페이지로 돌아갈 수 있음)",
                    firstPageIsStarted:
                        "설문지의 첫 번째 페이지는 시작 페이지입니다",
                    showCompletedPage:
                        "끝 부분에 완료된 페이지 표시 (완료된 HTML)",
                    goNextPageAutomatic:
                        "모든 질문에 응답 후 자동으로 다음 페이지로 이동",
                ...
                ts: { selectPage: "테스트 할 페이지를 선택하십시오:" },
                validators: {
            ...
            i.editorLocalization.locales.ms = {
                survey: {
                    edit: "Edit",
                    externalHelpLink:
                        "Tonton dan belajar cara mencipta tinjauan",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion:
                        "Sila letakkan soalan di sini daripada Kotak Alat",
                    addLogicItem:
                        "Cipta peraturan untuk menyesuaikan aliran tinjauan.",
                    copy: "Salin",
                    duplicate: "Pendua",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        completedHtmlOnConditionName:
                            "Teks 'Halaman terima kasih' tersuai",
                        page_visibilityDescription:
                            "Jadikan halaman boleh dilihat apabila ekspresi logik mengembalikan nilai benar. Jika tidak, biarkan tersembunyi.",
                        panel_visibilityDescription:
                            "Jadikan panel boleh dilihat apabila ekspresi logik mengembalikan nilai benar. Jika tidak, biarkan tersembunyi.",
                        panel_enableDescription:
                            "Jadikan panel dan semua elemen dalamnya didayakan apabila ekspresi logik mengembalikan nilai benar. Jika tidak, biarkan lumpuh.",
                        question_visibilityDescription:
                            "Jadikan soalan boleh dilihat apabila ekspresi logik mengembalikan nilai benar. Jika tidak, biarkan tersembunyi.",
                        question_enableDescription:
                            "Jadikan soalan didayakan apabila ekspresi logik mengembalikan nilai benar. Jika tidak, biarkan lumpuh.",
                        question_requireDescription:
                            "Soalan diperlukan apabila ekspresi logik mengembalikan nilai benar.",
                        trigger_completeDescription:
                            "Apabila ekspresi logik mengembalikan nilai benar, maka tinjauan akan lengkap dan pengguna akhir akan melihat 'Halaman terima kasih'.",
                        trigger_setvalueDescription:
                            "Apabila nilai soalan, yang digunakan dalam ekspresi logik, berubah dan ekspresi logik mengembalikan nilai benar, maka nilai ditetapkan kepada soalan yang dipilih.",
                        trigger_copyvalueDescription:
                            "Apabila nilai soalan, yang digunakan dalam ekspresi logik, berubah dan ekspresi logik mengembalikan nilai benar, maka nilai salah satu soalan yang dipilih akan disalin kepada satu lagi soalan yang dipilih.",
                        trigger_skipDescription:
                            "Apabila ekspresi logik mengembalikan nilai benar, maka tinjauan melangkau kepada / fokus pada soalan yang dipilih.",
                        trigger_runExpressionDescription:
                            "Apabila ekspresi mengembalikan nilai benar, maka ekspresi tersuai akan dilaksanakan. Anda boleh menetapkan keputusan ekspresi ini kepada soalan yang dipilih secara pilihan",
                        completedHtmlOnConditionDescription:
                            "Apabila ekspresi logik mengembalikan nilai benar, maka teks lalai untuk 'Halaman terima kasih' berubah kepada teks yang diberikan.",
                        itemExpressionText:
                            "Apabila ekspresi: '{0}' mengembalikan nilai benar:",
                        page_visibilityText:
                            "Jadikan halaman {0} boleh dilihat",
                        panel_visibilityText: "Jadikan panel {0} boleh dilihat",
                        panel_enableText: "Jadikan panel {0} didayakan",
                        question_visibilityText:
                            "Jadikan soalan {0} boleh dilihat",
                        ...
                        trigger_setvalueText:
                            "Tetapkan kepada soalan: {0} nilai {1}",
                        trigger_copyvalueText:
                            "Salin kepada soalan: {0} nilai daripada soalan {1}",
                        trigger_skipText: "Tinjauan melangkau ke soalan {0}",
                        trigger_runExpressionText1: "Jalankan ekspresi: '{0}'",
                        trigger_runExpressionText2:
                            " dan tetapkan keputusannya kepada soalan: {0}",
                        completedHtmlOnConditionText:
                            "Tunjukkan teks tersuai untuk 'Halaman terima kasih'.",
                        conditions: "Syarat",
                        actions: "Tindakan",
                        ...
                        expressionInvalid:
                            "Ekspresi logik kosong atau tidak sah. Sila betulkannya.",
                        noActionError:
                            "Sila tambahkan sekurang-kurangnya satu tindakan.",
                        actionInvalid:
                            "Sila baiki masalah dalam tindakan anda.",
                    },
                },
                pe: {
                    apply: "Guna",
                    ...
                    expressionHelp:
                        "Anda boleh gunakan kurungan kerinting untuk mengakses nilai soalan: {soalan1} + {soalan2}, ({harga}*{kuantiti}) * (100 - {diskaun}). Anda boleh menggunakan fungsi seperti: iif(), today(), age(), min(), max(), count(), avg() dan lain-lain.",
                    aceEditorHelp:
                        "Tekan ctrl+space untuk mendapatkan petunjuk lengkapan ekspresi",
                    ...
                    cellsEmptyRowsColumns:
                        "Terdapat sekurang-kurangnya satu lajur atau baris",
                    ...
                    storeDataAsText:
                        "Simpan kandungan fail dalam keputusan JSON sebagai teks",
                    ...
                    cookieName:
                        "Nama kuki (untuk melumpuhkan perlaksanaan tinjauan dua kali secara setempat)",
                    sendResultOnPageNext:
                        "Hantar keputusan tinjauan pada halaman seterusnya",
                    storeOthersAsComment:
                        "Simpan nilai 'lain-lain' dalam medan berasingan",
                    ...
                    showNavigationButtons:
                        "Tunjukkan butang navigasi (navigasi lalai)",
                    showPrevButton:
                        "Tunjukkan butang sebelumnya (pengguna boleh kembali ke halaman seterusnya)",
                    firstPageIsStarted:
                        "Halaman pertama dalam tinjauan ialah halaman permulaan.",
                    showCompletedPage:
                        "Tunjukkan halaman lengkap pada hujung (HTML dilengkapkan)",
                    goNextPageAutomatic:
                        "Selepas menjawab semua soalan, pergi ke halaman seterusnya secara automatik",
                    showProgressBar: "Tunjukkan bar perkembangan",
                    questionTitleLocation: "Lokasi tajuk soalan",
                    requiredText: "Soalan memerlukan simbol",
                    questionStartIndex:
                        "Indeks mula soalan (1, 2 atau 'A', 'a')",
                    showQuestionNumbers: "Tunjukkan nombor soalan",
                    questionTitleTemplate:
                        "Templat tajuk soalan, lalai ialah: '{tidak}. {perlukan} {tajuk}'",
                    questionErrorLocation: "Lokasi ralat soalan",
                    focusFirstQuestionAutomatic:
                        "Fokus soalan pertama pada perubahan halaman",
                    questionsOrder: "Susunan elemen pada halaman",
                    maxTimeToFinish:
                        "Masa maksimum untuk menyelesaikan tinjauan",
                    maxTimeToFinishPage:
                        "Masa maksimum untuk menyelesaikan halaman dalam tinjauan",
                    page: {},
                    question: {},
                    ...
                    titleKeyboardAdornerTip:
                        "Tekan butang enter untuk mengedit",
                    keyboardAdornerTip:
                        "Tekan butang enter untuk mengedit item, tekan butang padam untuk memadamkan item, tekan butang alt dan anak panah ke atas atau ke bawah untuk menggerakkan item",
                    triggerOn: "Hidup ",
                    ...
                    triggerIsVariable:
                        "Jangan letakkan pemboleh ubah dalam keputusan tinjauan.",
                    triggerRunExpressionEmpty:
                        "Sila masukkan ekspresi yang sah",
                ...
                pv: {
                    ...
                    showAnsweredQuestions:
                        "tunjukkan pratonton dengan soalan dijawab",
                    pages: "halaman",
                    questions: "soalan",
                ...
                triggers: {
                    ...
                    runexpressiontrigger: "jalankan ekspresi",
                    visibletrigger:
                        "ubah kebolehlihatan (tidak digunakan lagi)",
                },
                pehelp: { choicesbyurl: {} },
                p: {
                    title: {
                    ...
                    visibleIf: "Boleh dilihat jika",
                    useDisplayValuesInDynamicTexts:
                        "Guna nilai paparan dalam tajuk",
                    ...
                    detailPanelShowOnAdding:
                        "Butiran panel tunjukkan pada penambahan",
                    logoFit: "Muat logo",
                    pages: "halaman",
                    triggers: "pencetus",
                    calculatedValues: "Nilai dikira",
                    ...
                    itemSize: "Saiz item",
                    navigationButtonsVisibility:
                        "Kebolehlihatan butang navigasi",
            ...
            i.editorLocalization.locales.mn = {
                survey: {
                    edit: "Засах",
                    ...
                    addLogicItem:
                        "Санал асуулгын урсгалыг өөрчлөх дүрэм үүсгэнэ үү.",
                    copy: "Хуулах",
                ...
                ed: {
                    ...
                    surveyResultsTable:
                        "Санал асуулгын хариултыг хүснэгтээр харуулах",
                    surveyResultsJson: "As JSON",
                    ...
                    lg: {
                        ...
                        question_enableName:
                            "Асуулт идэвхжүүлэх (идэвхгүй болгох)",
                        question_requireName:
                            "Асуултыг заавал бөглөөөөх болгох",
                        column_visibilityName: "Багана харуулах (нуух).",
                        column_enableName:
                            "Багана идэвхжүүлэх (идэвхгүй болгох).",
                        ...
                        question_visibilityText:
                            "{0} асуултыг харагддаг болгох",
                        question_enableText: "{0} асуултыг идэвхжүүлэх",
                        question_requireText:
                            "{0} асуултыг заавал бөглөх болгох",
                        column_visibilityText:
                            "{0} баганын {1} асуултыг харагддаг болгох",
                        column_enableText:
                            "{0} баганын {1} асуултыг идэвхжүүлэх",
                        column_requireText:
                            "{0} баганын {1} асуултыг заавал бөглөх болгох",
                        trigger_completeText:
                            "Санал асуулга амжилттай бөглөсөн.",
                        trigger_setvalueText: "{0} Асуултад оруулах утга: {1}",
                        trigger_copyvalueText:
                            "{0} Асуулт руу хуулах утга: {1}",
                        trigger_skipText: "{0} Санал асуулгын асуулт руу үсрэх",
                        trigger_runExpressionText1:
                            "'{0}' илэрхийлэлг ажиллуулах: ",
                        trigger_runExpressionText2:
                            " Түүний хариултыг асуултад оруулах: {0}",
                        completedHtmlOnConditionText:
                        ...
                        uncompletedRule_cancel:
                            "Үгүй, дүрмийг үргэлжлүүлж бичиж дуусгах.",
                        expressionSetup: "",
                        actionsSetup: "",
                    },
                },
                pe: {
                    ...
                    fastEntryChoicesCountError:
                        "Хэсгийг {0}-оос {1} хүртэл хязгаарлах",
                    fastEntryPlaceholder:
                    ...
                    aceEditorHelp:
                        "ctrl+space дарж илэрхийлэл биелэгдэх сануулга харах.",
                    ...
                    cellsEmptyRowsColumns:
                        "Багадаа нэг багана эсвэл мөр байх ёстой",
                    showPreviewBeforeComplete:
                    ...
                    "listIsEmpty@choices":
                        "Одоогор ямар ч сонголт ороогүй байна",
                    ...
                    titleName:
                        "Үзүүлэн текстүүдийг дараагийн JSON талбараас авах",
                    ...
                    storeDataAsText:
                        "JSON үр дүнд файлын агуулгыг текст хэлбэрээр хадгалах",
                    ...
                    emptyLogicPopupMessage:
                        "Нөхцөл тохируулахын тулд асуултыг сонгоно уу.",
                    if: "Хэрэв",
                    then: "бол",
                    ...
                    sendResultOnPageNext:
                        "Хэсэгчилсэн санал асуулгын явцыг хадгалах",
                    ...
                    completeText:
                        "Санал асуулга амжиллттай бөглөгдсөн - харагдах бичиг",
                    ...
                    showCompletedPage:
                        "Санал асуулга амжилттай бөглөгдсөн хуудсыг харуулах",
                    goNextPageAutomatic:
                        "Дараагийн хуудас руу автоматаар шилжих",
                    ...
                    focusFirstQuestionAutomatic:
                        "Эхний асуултыг шинэ хуудсанд төвлөрүүлэх",
                    questionsOrder: "Хуудас дээрх элементийн дараалал",
                    maxTimeToFinish:
                        "Санал асуулга бөглөж дуусах хугацаа (секундээр)",
                    maxTimeToFinishPage:
                        "Нэг хуудас бөглөж дуусах хугацаа (секундээр)",
                    image: {
                        imageHeight:
                            "Зургийн өндөр (CSS хүлээн зөвшөөрсөн утга)",
                        imageWidth:
                            "Зургийн өргөн (CSS хүлээн зөвшөөрсөн утга)",
                    },
                    page: {
                        maxTimeToFinish:
                            "Нэг хуудас бөглөж дуусах хугацаа (секундээр)",
                    },
                    question: { page: "Эх хуудас" },
                    ...
                    autoGrowComment:
                        "Шаардлагатай үед санал сэтгэгдлийн хэсгийг өргөсгөх",
                    ...
                    loadingHtml:
                        "Судалгааны загвар ачааллаж байх үед харуулах тэмдэглэгээ",
                    ...
                    paneldynamic: { confirmDelete: "Панел устгахыг батлах" },
                    ...
                    columnMinWidth:
                        "Баганы хамгийн бага утга (CSS хүлээн зөвшөөрсөн утга)",
                    rowTitleWidth:
                        "Мөрийн гарчгийн утга (CSS хүлээн зөвшөөрсөн утга)",
                    valueTrue: "Үнэн утга",
                    valueFalse: "Худал утга",
                    minErrorText:
                        "Хамгийн бага утгаас бага байна! алдааны мэдэгдэл",
                    maxErrorText:
                        "Хамгийн их утгаас их байна! алдааны мэдэгдэл",
                    ...
                    choicesFromQuestion:
                        "Дараах асуултаас сонголтуудыг хуулах.",
                    ...
                    triggerIsVariable:
                        "Хувьсагч санал асуулгын үр дүнд оруулахгүй байх.",
                    ...
                    closeOnSelect:
                        "Сонголт хийсэн үед доош буусан сонголтуудыг хаах",
                ...
                pv: {
                    ...
                    list: "Жагсаалт",
                    progressTop:
                        "Панел чиглүүлэгч + Явцын мөр дээд хэсэгт байрлах",
                    progressBottom:
                        "Панел чиглүүлэгч + Явцын мөр доод хэсэгт байрлах",
                    progressTopBottom:
                    ...
                    onHiddenContainer:
                        "Асуулт, панел эсвэл хуудас нуугдсан үед",
                    clearInvisibleValues: { none: "Хэзээ ч үгүй" },
                    all: "Бүх",
                    page: "Хуудас",
                    survey: "Санал асуулга",
                    ...
                    showAnsweredQuestions:
                        "Зөвхөн хариулсан асуултуудыг харуулах.",
                    ...
                    showNavigationButtons: { none: "Нуусан" },
                    showProgressBar: { off: "Нуусан" },
                    showTimerPanel: { none: "Нуусан" },
                    showTimerPanelMode: { all: "Аль аль нь" },
                    detailPanelMode: { none: "Нуусан" },
                    addRowLocation: {
                        default: "Матрицын загвараас шалтгаалах",
                    },
                    panelsState: {
                        default:
                            "Хэрэглэгчид панелийг өргөсгөж багасгаж чадахгүй",
                ...
                ts: {
                    ...
                    showInvisibleElements:
                        "Харагдахгүй элементүүдийг харуулах.",
                ...
                pehelp: {
                    cookieName:
                        "Хэрэглэгч нэг судалгааг хоёр удаа бөглөхөөс Күүки сэргийлнэ.",
                    ...
                    columnColCount:
                        "Зөвхөн олон сонголттой эсвэл Radiogroup -д ашиглана.",
                    autocomplete:
                ...
                p: {
                    ...
                    surveyShowDataSaving:
                        "Санал асуулга өгөгдөл хадгалж байхад харуулах",
                    ...
                    useDisplayValuesInDynamicTexts:
                        "Динамик текстэд харуулах утгыг хэрэглэх",
                    visibleIf: "Харагдана хэрэв",
                    ...
                    totalMaximumFractionDigits:
                        "Нийт хамгийн их бутархай тоонууд",
                    totalMinimumFractionDigits:
                        "Нийт хамгийн бага бутархай тоонууд",
                    columns: "Баганууд",
                    ...
                    detailPanelShowOnAdding:
                        "Нэмэж байх үед нарийвчилсан панел харуулах",
            ...
            i.editorLocalization.locales.nb = {
                survey: {
                    edit: "Rediger",
                    ...
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion:
                        "Dra og slipp et spørsmål her fra Verktøylisten til venstre.",
                    addLogicItem:
                        "Opprett en regel for å skreddersy skjemaflyten",
                    copy: "Kopier",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        itemExpressionText:
                            "Når formelen: '{0}' evalueres til 'sann':",
                        ...
                        trigger_copyvalueText:
                            "Kopier inn: {0} verdi fra spørsmål {1}",
                        trigger_skipText: "Hopp til spørsmål {0}",
                        trigger_runExpressionText1: "Kjør formel: '{0}'",
                        trigger_runExpressionText2:
                            " og sett inn resultatet i spørsmål: {0}",
                        completedHtmlOnConditionText:
                            "Vis tilpasset tekst for 'Takk-siden'.",
                        conditions: "Vilkår",
                        actions: "Handling(er)",
                ...
                pe: {
                    ...
                    conditionValueQuestionTitle:
                        "Vennligst skriv inn/velg verdi",
                    expressionHelp:
                    ...
                    aceEditorHelp:
                        "Trykk ctrl+mellomrom for å få hint til å fullføre formler",
                    ...
                    cellsEmptyRowsColumns:
                        "Det må være minst 1 kolonne eller rad",
                    ...
                    storeDataAsText:
                        "Lagre filinnhold i JSON-resultat som tekst",
                    ...
                    storeOthersAsComment:
                        "Lagre 'andre' verdier i et separat felt",
                    ...
                    showNavigationButtons:
                        "Vis navigasjonsknapper (standard navigering)",
                    showPrevButton:
                        "Vis forrige knapp (bruker kan gå til forrige side)",
                    firstPageIsStarted:
                        "Den første siden i skjema er startside.",
                    showCompletedPage:
                        "Vis ferdigsiden på slutten (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Spørsmål startindeks (1, 2 eller 'A', 'a')",
                    ...
                    maxTimeToFinishPage:
                        "Maks tid til å gjøre ferdig en side i skjema",
                    page: {},
                    question: {},
                    ...
                    titleKeyboardAdornerTip:
                        "Trykk enter-tasten for å redigere",
                    keyboardAdornerTip:
                    ...
                    triggerRunExpressionEmpty:
                        "Vennligst fyll inn en gyldig formel",
            ...
            i.editorLocalization.locales.fa = {
                survey: {
                    edit: "ویرایش",
                    externalHelpLink:
                        "نگاه کنید و ساختن نظرسنجی را آموزش ببینید",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion: "لطفا از جعبه ابزار سوالی در اینجا قرار دهید",
                    addLogicItem:
                        "برای شخصی سازی نظرسنجی خود، قانونی را ایجاد کنید",
                    copy: "کپی",
                    duplicate: "کپی کردن",
                ...
                ed: {
                    ...
                    panelPlaceHolder:
                        "سوالی را از داخل جعبه ابزار در اینجا قرار دهید",
                    surveyPlaceHolder:
                        "نظرسنجی خالی است. یک آیتم را از جعبه ابزار انتخاب یا روی دکمه ی زیر کلیک کنید",
                    addNewTypeQuestion: "اضافه {0}",
                    chooseLogoPlaceholder: "[لوگو]",
                    lg: {
                        addNewItem: "اضافه کردن آیتم جدید",
                        empty_tab:
                            "یک آیتم را برای سفارشی کردن جریان نظرسنجی انتخاب کنید",
                        ...
                        trigger_skipDescription:
                            "زمانی که عبارت منطقی صحیح برمی گرداند، سپس نظرسنجی به سوال انتخابی می رود.",
                        trigger_runExpressionDescription:
                        ...
                        itemExpressionText:
                            "زمانی که عبارت {0} مقدار صحیح بر می گرداند",
                        ...
                        trigger_setvalueText:
                            "در سوال {0} مقدار {1} را قرار دهید",
                        trigger_copyvalueText:
                            "مقدار سوال {0} را از سوال {1} کپی کنید.",
                        trigger_skipText: "رد کردن نظرسنجی برای سوال {0}",
                        trigger_runExpressionText1: "اجرای عبارت '{0}' ",
                        trigger_runExpressionText2:
                            "و نتیجه آن را داخل سوال {0} ذخیره کنید",
                        completedHtmlOnConditionText:
                ...
                pe: {
                    ...
                    conditionValueQuestionTitle:
                        "لطفا مقدار را انتخاب / وارد کنید",
                    expressionHelp:
                    ...
                    storeDataAsText:
                        "ذخیره کردن محتوای فایل در JSON به عنوان متن",
                    ...
                    cookieName:
                        "نام کوکی (به منظور جلوگیری از اجرای دوباره نظرسنجی)",
                    ...
                    showNavigationButtons:
                        "نمایش دکمه های ناوبری (ناوبری پیش فرض)",
                    showPrevButton:
                        "نمایش دکمه قبلی (کاربر ممکن است به صفحه قبل برگردد)",
                    firstPageIsStarted:
                        "صفحه اول در نظرسنجی نقطه آغازین آن است.",
                    showCompletedPage:
                        "نمایش صفحه اتمام نظرسنجی در پایان (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    titleKeyboardAdornerTip:
                        "برای ویرایش دکمه ی enter را فشار دهید.",
                    keyboardAdornerTip:
                        "برای ویرایش دکمه ی enter را فشار دهید, برای حذف دکمه ی delete را فشار دهید, برای حرکت دادن یک آیتم، دکمه ی  alt + arrow down /  alt + arrow up فشار دهید",
                    triggerOn: "در ",
                ...
                pv: {
                    ...
                    showAnsweredQuestions:
                        "فعال سازی پیش نمایش به سوالات پاسخ داده شده",
                    showNavigationButtons: {},
                    showProgressBar: {},
                    showTimerPanel: {},
                    showTimerPanelMode: {},
            ...
            i.editorLocalization.locales.pl = {
                survey: {
                    edit: "Edytuj",
                ...
                pe: {
                    ...
                    storeOthersAsComment:
                        "Store 'others' value in separate field",
                    ...
                    showNavigationButtons:
                        "Show navigation buttons (default navigation)",
                    showPrevButton:
                        "Show previous button (user may return on previous page)",
                    firstPageIsStarted:
                        "The first page in the survey is a started page.",
                    showCompletedPage:
                        "Show the completed page at the end (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Question start index (1, 2 or 'A', 'a')",
                    ...
                    maxTimeToFinishPage:
                        "Maximum time to finish a page in the survey",
                    page: {},
                    question: {},
                ...
                ts: { selectPage: "Wybierz stronę, aby ją przetestować:" },
                validators: {
                    answercountvalidator: "answer count",
                    emailvalidator: "e-mail",
                    numericvalidator: "numeric",
            ...
            i.editorLocalization.locales.pt = {
                survey: {
                    ...
                    license:
                        "COMPRE UMA LICENÇA DE PROGRAMADOR PARA PODER USAR O SURVEY CREATOR NA SUA APLICAÇÃO",
                },
                qt: {
                ...
                ed: {
                    ...
                    panelPlaceHolder:
                        "Arraste uma questão da caixa de ferramentas aqui.",
                    surveyPlaceHolder:
                        "O questionário está vazio. Arraste um elemento da caixa de ferramentas ou clique no botão abaixo.",
                    ...
                    lg: {
                        ...
                        empty_tab:
                            "Crie uma regra para personalizar o fluxo do questionário.",
                        ...
                        completedHtmlOnConditionName:
                            'Definir marcação de página de "Questionário Completo"',
                        page_visibilityDescription:
                            "Torne a página visível quando a expressão lógica estiver ativa. Caso contrário, mantenha-o invisível.",
                        panel_visibilityDescription:
                            "Torne o painel visível quando a expressão lógica estiver ativa. Caso contrário, mantenha-o invisível.",
                        panel_enableDescription:
                            "Faça com que o painel e todos os elementos dentro dele sejam ativos quando a expressão lógica estiver ativa. Caso contrário, mantenha-o invisível.",
                        question_visibilityDescription:
                            "Torne a pergunta visível quando a expressão lógica estiver ativa. Caso contrário, mantenha-a invisível.",
                        question_enableDescription:
                            "Ative a pergunta quando a expressão lógica estiver ativa. Caso contrário, mantenha-a invisível.",
                        question_requireDescription:
                            "A pergunta torna-se obrigatória quando a expressão lógica estiver ativa.",
                        trigger_completeDescription:
                            "Quando a expressão lógica estiver ativa, a pesquisa será concluída e o utilizador verá a 'Página de Agradecimento'.",
                        trigger_setvalueDescription:
                            "Quando os valores da pergunta, que são usados na expressão lógica, são alterados e a expressão lógica fica ativa, então o valor é definido para a pergunta seleccionada.",
                        trigger_copyvalueDescription:
                            "Quando os valores das perguntas, que são usados na expressão lógica, são alterados e a expressão lógica fica ativa, então o valor de uma pergunta seleccionada é copiado para outra pergunta seleccionada.",
                        trigger_skipDescription:
                            "Quando a expressão lógica volta a ser ativa, então o questionário salta para / focaliza a pergunta seleccionada.",
                        trigger_runExpressionDescription:
                            "Quando a expressão lógica volta a ser ativaa, a expressão personalizada é executada. Opcionalmente, pode definir o resultado desta expressão para a pergunta seleccionada",
                        completedHtmlOnConditionDescription:
                            "Se a expressão lógica estiver ativa, então o texto padrão para a 'Página de agradecimento' é alterado para a dada.",
                        itemExpressionText:
                            "Quando a expressão: '{0}' volta a ficar ativa",
                        ...
                        column_visibilityText:
                            "tornar coluna {0} da questão {1} visível",
                        column_enableText:
                            "tornar coluna {0} da questão {1} ativa",
                        column_requireText:
                            "torna coluna {0} da questão {1} obrigatória",
                        trigger_completeText: "o questionário fica completo",
                        trigger_setvalueText:
                            "Colocar em questão: {0} valor {1}",
                        trigger_copyvalueText:
                            "Copiar a questão: {0} valor da questão {1}",
                        trigger_skipText:
                            "pular para a questão do questionário {0}",
                        trigger_runExpressionText1: "executar expressão: '{0}'",
                        trigger_runExpressionText2:
                            " e colocar seu resultado em questão: {0}",
                        completedHtmlOnConditionText:
                            "mostrar texto costumizado para a 'página de agradecimento'.",
                        ...
                        expressionInvalid:
                            "A expressão lógica está vazia ou é inválida. Por favor corrija.",
                        noActionError:
                            "Por favor, adicione pelo menos uma ação.",
                        actionInvalid:
                            "Por favor, corrija os problemas nas sua(s) ação(ões).",
                ...
                pe: {
                    ...
                    fastEntryChoicesCountError:
                        "Limite o número de itens de {0} a {1}",
                    fastEntryPlaceholder:
                        "Pode definir dados no seguinte formato:\nvalor1|texto\nvalor2",
                    ...
                    conditionValueQuestionTitle:
                        "Por favor, entre/selecione o valor",
                    expressionHelp:
                    ...
                    showMore:
                        "Para mais detalhes, por favor visite a documentação",
                    assistantTitle: "Perguntas disponíveis:",
                    cellsEmptyRowsColumns:
                        "Deve haver ao menos uma coluna ou linha",
                    showPreviewBeforeComplete:
                        "Visualize as respostas antes de submeter o questionário",
                    propertyIsEmpty:
                        "Por favor informe um valor na propriedade",
                    ...
                    imageLinkName:
                        "Obtenha URLs de imagem do seguinte campo JSON",
                    ...
                    choicesMin:
                        "Valor mínimo para itens gerados automaticamente",
                    choicesMax:
                        "Valor máximo para itens gerados automaticamente",
                    ...
                    storeDataAsText:
                        "Gravar conteúdo de arquivo no resultado JSON como texto",
                    ...
                    emptyLogicPopupMessage:
                        "Selecione uma pergunta para começar a configurar as condições.",
                    if: "Se",
                    then: "em seguida",
                    ...
                    cookieName:
                        "Nome do cookie (para desativar rode a pesquisa duas vezes localmente)",
                    sendResultOnPageNext:
                        "Enviar resultado da pesquisa na página seguinte",
                    storeOthersAsComment:
                        "Armazenar 'outros' valores em um campo separado",
                    ...
                    editText:
                        "Editar o texto do botão Responder Answer button text",
                    startSurveyText: "Texto para botão de começar",
                    showNavigationButtons:
                        "Mostrar botões de navegação (navegação default)",
                    showPrevButton:
                        "Mostrar botão de voltar (usuário pode retornar para página anterior)",
                    firstPageIsStarted:
                        "Primeira página da pesquisa é a página de início.",
                    showCompletedPage:
                        "Mostrar a página de conclusão no final (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Index das perguntas (1, 2 or 'A', 'a')",
                    ...
                    focusFirstQuestionAutomatic:
                        "Focar automaticamente na primeira pergunta ao trocar de página",
                    questionsOrder: "Ordenar elementos na página",
                    maxTimeToFinish: "Tempo máximo para finalizar pesquisa",
                    maxTimeToFinishPage:
                        "Tempo máximo para finalizar página da pesquisa",
                    page: {
                        maxTimeToFinish:
                            "Tempo limite para finalizar esta página (em segundos)",
                    },
                    question: { page: "Página principal" },
                    ...
                    responsiveImageSizeHelp:
                        "Não se aplica se especificar a largura ou altura exata da imagem.",
                    ...
                    autoGrowComment:
                        "Expanda automaticamente a área de comentários, se necessário",
                    textUpdateMode: "Atualizar valor da pergunta de texto",
                    focusOnFirstError:
                        "Defina o foco na primeira resposta inválida",
                    checkErrorsMode: "Executar validação",
                    navigateToUrl: "Navegar para URL",
                    navigateToUrlOnCondition: "URL Dinamico",
                    completedBeforeHtml:
                        "Marcação para mostrar se o utilizador já preencheu este questionário",
                    completedHtml:
                        "Marcação de página completa do questionário",
                    completedHtmlOnCondition:
                        "Marcação de página completa de questionário dinâmico",
                    loadingHtml:
                        "Marcação para mostrar enquanto o modelo de questionário está carregando",
                    ...
                    panelPrevText:
                        "Dica de ferramenta do botão do painel anterior",
                    panelNextText:
                        "Dica de ferramenta do botão do painel seguinte",
                    showRangeInProgress: "MOstrar barra de progresso",
                    templateTitleLocation: "Localização do título da pergunta",
                    panelRemoveButtonLocation:
                        "Remover localização do botão do painel",
                    ...
                    hideIfChoicesEmpty:
                        "Oculte a pergunta se ela não contiver opções",
                    ...
                    columnMinWidth:
                        "Largura mínima da coluna (em valores aceitos pelo CSS)",
                    rowTitleWidth:
                        "Largura do cabeçalho da linha (em valores aceitos por CSS)",
                    valueTrue: '"Verdadeiro" valor',
                    valueFalse: '"Falso" valor',
                    minErrorText:
                        '"O valor está abaixo do mínimo" mensagem de erro',
                    maxErrorText: '"O valor excede o máximo" mensagem de erro',
                    otherErrorText: '"Comentário vazio" mensagem de erro',
                    keyDuplicationError:
                        '"Valor de chave não exclusivo" mensagem de erro',
                    ...
                    logoWidth:
                        "Largura do logotipo (em valores aceitos pelo CSS)",
                    logoHeight:
                        "Altura do logotipo (em valores aceitos pelo CSS)",
                    readOnly: "Apenas para leitura",
                    enableIf: "Editável se",
                    emptyRowsText: '"Sem linhas" mensagem',
                    size: "Tamanho de entrada (em caracteres)",
                    separateSpecialChoices:
                        "Escolhas especiais separadas (Nenhuma, Outra, Selecionar Tudo)",
                    choicesFromQuestion: "Copie as opções da seguinte pergunta",
                    choicesFromQuestionMode:
                        "Quais as opções pretendem copiar?",
                    showCommentArea: "Mostrar a área de comentários",
                    commentPlaceholder:
                        "Espaço reservado para área de comentários",
                    displayRateDescriptionsAsExtremeItems:
                        "Exibir descrições de taxa como valores extremos",
                    ...
                    itemvalue: { text: "Texto alternativo" },
                    ...
                    panel: { indent: "Adicionar recuos externos" },
                    innerIndent: "Adicionar recuos internos",
                    defaultValueFromLastRow:
                        "Utilizar os valores padrão da última linha",
                    defaultValueFromLastPanel:
                        "Utilizar os valores padrão do último painel",
                    ...
                    keyboardAdornerTip:
                        "Pressione o botão enter para editar o item, pressione o botão delete para excluir o item, pressione alt mais a seta para cima ou a seta para baixo para mover o item",
                    triggerOn: "Ligado ",
                    triggerMakePagesVisible: "Tornar páginas visíveis:",
                    triggerMakeQuestionsVisible: "Tornar perguntas visíves:",
                    triggerCompleteText:
                        "Completar a pesquisa se obtiver êxito.",
                    ...
                    triggerIsVariable:
                        "Não colocar a variável no resultado da pesquisa.",
                    triggerRunExpressionEmpty:
                        "Introdução uma expressão valida",
                    emptyExpressionPlaceHolder: "Escreva a expressão aqui...",
                    noFile: "Nenhum ficheiro selecionado",
                    clearIfInvisible:
                        "Limpe o valor se a questão for escondida",
                ...
                pv: {
                    ...
                    onHidden: "ao ocultar",
                    onHiddenContainer:
                        "Quando a pergunta ou seu painel/página fica oculto",
                    clearInvisibleValues: { none: "Nunca" },
                    all: "todos",
                    page: "página",
                    survey: "pesquisa",
                    ...
                    showNavigationButtons: { none: "Escondido" },
                    showProgressBar: { off: "Escondido" },
                    showTimerPanel: { none: "Escondido" },
                    showTimerPanelMode: { all: "Ambos" },
                    detailPanelMode: { none: "Escondido" },
                    addRowLocation: { default: "Depende do layout da matriz" },
                    panelsState: {
                        default:
                            "Os utilizadores não podem expandir ou recolher painéis",
                ...
                pehelp: {
                    cookieName:
                        "Os cookies impedem que os usuários preencham a mesma pesquisa duas vezes.",
                    format: "Utilizar {0} como um espaço reservado para o valor real.",
                    totalText:
                        "Visível apenas quando pelo menos uma coluna tiver tipo total ou expressão total.",
                    acceptedTypes:
                        "Consulte o [aceitar](https://www.w3schools.com/tags/att_input_accept.asp) descrição do atributo para mais informações.",
                    columnColCount:
                        "Aplicável apenas aos tipos de célula Grupo de Rádio e Caixa de Seleção.",
                    autocomplete:
                        "Consulte o [autocompleto](https://developer.mozilla.org/en-US/docs/Web/HTML/Attributes/autocomplete) descrição do atributo para mais informações.",
                    valueName:
                        "Se você não definir esta propriedade, a resposta será armazenada em um campo especificado pela propriedade Nome.",
                    choicesbyurl: { valueName: "Nome" },
                    keyName:
                        'Se a coluna especifica contiver valores idênticos, o questionário lançará o "Valor de chave não exclusivo" erro.',
                },
                p: {
                    title: {
                        name: "título",
                    ...
                    useDisplayValuesInDynamicTexts:
                        "Usar valores de exibição em textos dinâmicos",
                    ...
                    totalMaximumFractionDigits:
                        "Total Máximo de Dígitos da Fração",
                    totalMinimumFractionDigits:
                        "Total Mínimo de Dígitos da Fração",
                    columns: "Colunas",
                    ...
                    detailPanelShowOnAdding:
                        "Mostrar ao adicionar painel de detalhes",
                    ...
                    surveyShowDataSaving:
                        "Mostrar economia de dados do questionário",
                    questionDescriptionLocation:
                        "Descrição da localização do questionário",
                    ...
                    choicesLazyLoadPageSize:
                        "Escolha carga lenta tamanho de página",
            ...
            i.editorLocalization.locales.ru = {
                survey: {
                    edit: "Редактировать",
                    ...
                    externalHelpLinkUrl:
                        "Https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion:
                        "Пожалуйста, перетяните необходимый элемент из панели слева",
                    copy: "Копировать",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        trigger_runExpressionName:
                            "Запустить пользовательское выражение",
                        completedHtmlOnConditionName:
                            "Пользовательский текст 'Страницы благодарности'",
                        page_visibilityDescription:
                        ...
                        itemExpressionText:
                            "Когда выражение: '{0}' возвращает 'true'",
                        ...
                        trigger_setvalueText:
                            "Установить в вопрос: {0} значение {1}",
                        trigger_copyvalueText:
                            "Копировать в вопрос: {0} значение из вопроса {1}",
                        trigger_skipText: "Опрос переходит к вопросу {0}",
                        trigger_runExpressionText1:
                            "Выполнить выражение: '{0}'",
                        trigger_runExpressionText2:
                            "и установить его результат в вопрос: {0}",
                        completedHtmlOnConditionText:
                ...
                pe: {
                    ...
                    conditionValueQuestionTitle:
                        "Пожалуйста, введите/выберите значение",
                    expressionHelp:
                    ...
                    aceEditorHelp:
                        "Нажмите Ctrl+Пробел, чтобы получить подсказки",
                    aceEditorRowTitle: "Текущая строка",
                    aceEditorPanelTitle: "Текущая панель",
                    showMore:
                        "Для получения более подробной информации, пожалуйста, перейдите к документации",
                    assistantTitle: "Доступные вопросы",
                    cellsEmptyRowsColumns:
                        "Должен быть хотя бы один столбец или строка",
                    propertyIsEmpty: "Пожалуйста, введите значение",
                    propertyNameIsNotUnique:
                        "Пожалуйста, введите уникальное имя",
                    ...
                    choicesMin:
                        "Минимальное значение для автоматически сгенерированных элементов",
                    choicesMax:
                        "Максимальное значение для автоматически сгенерированных элементов",
                    choicesStep:
                        "Разница между автоматически сгенерироваными элементами",
                    name: "Название",
                    title: "Заголовок",
                    cellType: "Тип ячейки",
                    ...
                    storeDataAsText:
                        "Хранить содержимое файла в формате JSON как текст",
                    ...
                    cookieName:
                        "Имя Cookie (отключить повторное прохождение опроса локально)",
                    sendResultOnPageNext:
                        "Показать результаты опроса на странице рядом",
                    storeOthersAsComment:
                        "Хранить занчение 'Другое' в отдельном поле",
                    ...
                    showNavigationButtons:
                        "Показывать кнопки навигации (навигация по умолчанию)",
                    showPrevButton:
                        "Показывать кнопки 'Предыдущая страница' (пользователь может вернуться на предыдущую страницу)",
                    firstPageIsStarted:
                        "Первая страница опросника является стартовой страницей.",
                    showCompletedPage:
                        "Показывать страницу с текстом по завершению заполнения (HTML финальной страницы)",
                    goNextPageAutomatic:
                        "Переходить на следующую страницу автоматически при заполнении всех вопросов",
                    ...
                    questionStartIndex:
                        "Начальный индекс вопроса (1, 2 или 'A', 'а')",
                    showQuestionNumbers: "Показывать номера вопросов",
                    questionTitleTemplate:
                        "Шаблон названия опроса, по умолчанию: {не} {требует} {текста}.",
                    questionErrorLocation: "Размещение ошибки опроса",
                    focusFirstQuestionAutomatic:
                        "Фокусирование на первом вопросе при изменении страницы",
                    questionsOrder: "Сортировка элементов на странице",
                    maxTimeToFinish:
                        "Максимальное время в секундах, чтобы заполнить опросник",
                    maxTimeToFinishPage:
                        "Максимальное время в секундах, чтобы заполнить страницу опросника",
                    page: {},
                    question: {},
                    ...
                    triggerIsVariable:
                        "Не помещать переменную в результат опросника.",
                    triggerRunExpressionEmpty:
            ...
            i.editorLocalization.locales["zh-cn"] = {
                survey: {
                    edit: "编辑",
            ...
            i.editorLocalization.locales.sk = {
                survey: {
                    edit: "Upraviť",
                    externalHelpLink:
                        "Sledovať a zistiť, ako vytvárať prieskumy",
                    externalHelpLinkUrl:
                        "https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion: "Sem zadajte otázku zo súpravy nástrojov.",
                    addLogicItem:
                        "Vytvoriť pravidlo prispôsobenia priebehu prieskumu.",
                    copy: "Kopírovať",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        completedHtmlOnConditionName:
                            "Vlastný text stránky s poďakovaním",
                        page_visibilityDescription:
                            "Stránka bude viditeľná, keď logický výraz vráti hodnotu true. V opačnom prípade sa nebude zobrazovať.",
                        panel_visibilityDescription:
                            "Panel bude viditeľný, keď logický výraz vráti hodnotu true. V opačnom prípade sa nebude zobrazovať.",
                        panel_enableDescription:
                            "Panel a všetky jeho prvky sa povolia, keď logický výraz vráti hodnotu true. V opačnom prípade budú zakázané.",
                        question_visibilityDescription:
                            "Otázka bude viditeľná, keď logický výraz vráti hodnotu true. V opačnom prípade sa nebude zobrazovať.",
                        question_enableDescription:
                            "Otázka sa povolí, keď logický výraz vráti hodnotu true. V opačnom prípade zostane zakázaná.",
                        question_requireDescription:
                            "Otázka bude povinná, keď logický výraz vráti hodnotu true.",
                        trigger_completeDescription:
                            "Keď logický výraz vráti hodnotu true, prieskum bude dokončený a používateľovi sa zobrazí stránka s poďakovaním.",
                        trigger_setvalueDescription:
                            "V prípade, že sa zmenia hodnoty, ktoré sa používajú v rámci logického výrazu, a logický výraz vráti hodnotu true, pre vybratú otázku sa nastaví daná hodnota.",
                        trigger_copyvalueDescription:
                            "V prípade, že sa zmenia hodnoty otázok, ktoré sa používajú v rámci logického výrazu, a logický výraz vráti hodnotu true, hodnota jednej vybratej otázky sa skopíruje na ďalšiu vybratú otázku.",
                        trigger_skipDescription:
                            "Keď logický výraz vráti hodnotu true, prieskum prejde/nastaví sa na vybratú otázku.",
                        trigger_runExpressionDescription:
                            "Keď logický výraz vráti hodnotu true, vykoná sa vlastný výraz. Voliteľne môžete nastaviť tento výraz na vybratú otázku.",
                        completedHtmlOnConditionDescription:
                            "Keď logický výraz vráti hodnotu true, predvolený text na stránke s poďakovaním sa zmení na zadaný text.",
                        itemExpressionText:
                            "Keď výraz: „{0}“ vráti hodnotu true:",
                        ...
                        trigger_setvalueText:
                            "Nastaviť v otázke: {0} hodnotu {1}",
                        trigger_copyvalueText:
                            "Kopírovať do otázky: {0} hodnotu z otázky {1}",
                        trigger_skipText: "V prieskume prejsť na otázku {0}",
                        trigger_runExpressionText1: "Spustiť výraz: „{0}“",
                        trigger_runExpressionText2:
                            " a nastaviť výsledok v otázke: {0}",
                        completedHtmlOnConditionText:
                            "Zobraziť vlastný text pre stránku s poďakovaním.",
                        ...
                        expressionInvalid:
                            "Logický výraz je prázdny alebo neplatný. Opravte ho.",
                ...
                pe: {
                    ...
                    expressionHelp:
                        "Pomocou zložených zátvoriek môžete získať prístup k hodnotám otázok: {question1} + {question2}, ({price}*{quantity}) * (100 - {discount}). Môžete používať funkcie ako: iif(), today(), age(), min(), max(), count(), avg() a iné.",
                    aceEditorHelp:
                        "Klávesovou skratkou ctrl+space získate tip na dokončenie výrazu",
                    aceEditorRowTitle: "Aktuálny riadok",
                    aceEditorPanelTitle: "Aktuálny panel",
                    showMore: "Ďalšie podrobnosti nájdete v dokumentácii",
                    assistantTitle: "Dostupné otázky:",
                    cellsEmptyRowsColumns:
                        "K dispozícii má byť aspoň jeden stĺpec alebo riadok",
                    ...
                    choicesMin:
                        "Minimálna hodnota pre automaticky vygenerované položky",
                    choicesMax:
                        "Maximálna hodnota pre automaticky vygenerované položky",
                    choicesStep:
                        "Rozdiel medzi automaticky vygenerovanými položkami",
                    name: "Názov",
                    title: "Titul",
                    cellType: "Typ bunky",
                    ...
                    storeDataAsText:
                        "Uložiť obsahu súboru vo výsledku JSON ako text",
                    ...
                    cookieName:
                        "Názov súboru cookie (na zabránenie lokálneho spustenia prieskumu dvakrát)",
                    sendResultOnPageNext:
                        "Odoslať výsledky prieskumu na ďalšiu stránku",
                    storeOthersAsComment:
                        "Uložiť hodnotu „iné“ v samostatnom poli",
                    ...
                    showNavigationButtons:
                        "Zobraziť navigačné tlačidlá (predvolená navigácia)",
                    showPrevButton:
                        "Zobraziť tlačidlo predchádzajúce (používateľ sa môže vráiť na predchádzajúcu stránku)",
                    firstPageIsStarted:
                        "Prvá stránka v prieskume je úvodná stránka.",
                    showCompletedPage:
                        "Na konci zobraziť stránku s dokončením (completedHtml)",
                    goNextPageAutomatic:
                        "Po zodpovedaní všetkých otázok prejsť na ďalšiu stránku automaticky",
                    ...
                    questionStartIndex:
                        "Otázka sa začína indexom (1, 2 alebo „A“, „a“)",
                    showQuestionNumbers: "Zobraziť čísla otázok",
                    questionTitleTemplate:
                        "Šablóna titulu otázky, predvolená je:  „{no}. {require} {title}“",
                    questionErrorLocation: "Poloha chyby otázky",
                    focusFirstQuestionAutomatic:
                        "Prechod na prvú otázku pri zmene stránky",
                    questionsOrder: "Poradie prvkov na stránke",
                    maxTimeToFinish: "Maximálny čas na dokončenie prieskumu",
                    maxTimeToFinishPage:
                        "Maximálny čas na dokončenie stránky v rámci prieskumu",
                    page: {},
                    question: {},
                    ...
                    keyboardAdornerTip:
                        "Stlačením tlačidla Enter položku upravíte, stlačením tlačidla Odstrániť položku odstránite, stlačením tlačidla Alt a šípky nahor alebo šípky nadol položku presuniete",
                    triggerOn: "Zap. ",
                    ...
                    triggerIsVariable:
                        "Nezaraďujte premennú do výsledku prieskumu.",
                ...
                pv: {
                    ...
                    showAnsweredQuestions:
                        "zobraziť ukážku so zodpovedanými otázkami",
                    pages: "stránky",
                    questions: "otázky",
                    requiredQuestions: "povinné otázky",
                ...
                p: {
                    ...
                    visibleIf: "Viditeľné ak",
                    useDisplayValuesInDynamicTexts:
                        "Použiť zobrazené hodnoty v titule",
                    ...
                    detailPanelShowOnAdding:
                        "panel s podrobnosťami – zobrazenie pri pridávaní",
                    ...
                    navigationButtonsVisibility:
                        "Viditeľnosť navigačných tlačidiel",
            ...
            i.editorLocalization.locales.es = {
                survey: {
                    edit: "Editar",
                    ...
                    addLogicItem:
                        "Cree una regla para personalizar el flujo de la encuesta",
                    copy: "Copiar",
                    duplicate: "Duplicar",
                ...
                ed: {
                    ...
                    saveError:
                        "¡Error!El contenido del editor no se ha guardado",
                    translationPropertyGridTitle: "Opciones de lenguaje",
                    translationLanguages: "Lenguajes",
                    translationAddLanguage:
                        "Seleccione el idioma para traducir",
                    ...
                    translationMergeLocaleWithDefault:
                        "Merge {0} con lugar predeterminado",
                    ...
                    panelPlaceHolder:
                        "Arrastra aquí una pregunta desde la caja de herramientas.",
                    surveyPlaceHolder:
                        "La encuesta está vacía. Arrastra una pregunta desde la caja de herramientas o haz click en el botón de abajo.",
                    addNewTypeQuestion: "Añadir {0}",
                    lg: {
                        addNewItem: "Añadir nueva regla",
                        empty_tab:
                            "Crea una regla para personalizar el flujo de la encuesta.",
                        ...
                        question_enableName:
                            "Pregunta habilitar / deshabilitar",
                        ...
                        trigger_runExpressionName:
                            "Ejecutar la expresión personalizada",
                        completedHtmlOnConditionName:
                            "Texto personalizado 'Página de agradecimiento'",
                        page_visibilityDescription:
                        ...
                        itemExpressionText:
                            "Cuando la expresión: '{0}' devuelve VERDADERO:",
                        ...
                        column_visibilityText:
                            "hacer la columna {0} de la pregunta {1} visible",
                        column_enableText:
                            "hacer la columna {0} de la pregunta {1} activa",
                        column_requireText:
                            "hacer la columna {0} de la pregunta {1} requerida",
                        trigger_completeText: "La encuesta se completa",
                        trigger_setvalueText: "En cuestión: {0} valor {1}",
                        trigger_copyvalueText:
                            "Copiar en cuestión: {0} valor de la pregunta {1}",
                        trigger_skipText: "Encuesta salta a la pregunta {0}",
                        trigger_runExpressionText1:
                            "Expresión de ejecución: '{0}'",
                        trigger_runExpressionText2:
                            "y establecer su resultado en cuestión: {0}",
                        completedHtmlOnConditionText:
                        ...
                        actionInvalid:
                            "Por favor, solucione problemas en su(s) acción(es)",
                        actionsSetup: " ",
                    },
                },
                pe: {
                    ...
                    fastEntryChoicesCountError:
                        "Por favor, limita el númeror de elementos de {0} a {1}",
                    fastEntryPlaceholder:
                        "Puedes introducir datos en el siguiente formato:\nvalue1|text\nvalue2",
                    ...
                    conditionValueQuestionTitle:
                        "Por favor ingrese / seleccione el valor",
                    expressionHelp:
                    ...
                    showMore:
                        "Para más detalles, por favor revise la documentación",
                    assistantTitle: "Preguntas disponibles:",
                    cellsEmptyRowsColumns:
                        "Debe haber al menos una columna o fila",
                    showPreviewBeforeComplete:
                        "Previsualizar respuestas entes de enviar la encuesta",
                    propertyIsEmpty: "Porfavor introduzca un valor",
                    propertyIsNoUnique: "Por favor ingrese un valor único",
                    propertyNameIsNotUnique:
                        "Por favor ingrese un nombre único",
                    ...
                    choicesMin:
                        "Valor mínimo para artículos generados automáticos",
                    choicesMax:
                        "Valor máximo para artículos generados automáticos",
                    choicesStep:
                        "La diferencia entre los artículos generados automáticos",
                    name: "Nombre",
                    title: "Título",
                    cellType: "Tipo de célula",
                    ...
                    emptyLogicPopupMessage:
                        "Selecciona una pegunta para epezar a configurar condiciones.",
                    if: "Si",
                    then: "entonces",
                    ...
                    includeIntoResult:
                        "Incluir en los resultados de la encuesta",
                    showTitle: "Mostrar / Ocultar Título",
                    ...
                    storeOthersAsComment:
                        "Almacenar 'Otros' valor en campo separado",
                    ...
                    page: {
                        maxTimeToFinish:
                            "Tiempo límite para finalizar la página (en segundos)",
                    },
                    question: { page: "Página padre" },
                    showTimerPanel: "Mostrar panel de temporizador",
                    showTimerPanelMode:
                        "Mostrar modo de panel del temporizador",
                    ...
                    responsiveImageSizeHelp:
                        "No aplica si especificas el ancho o alto exacto de la imagen.",
                    ...
                    maximumFractionDigits:
                        "Número máximo de dígitos de fracción",
                    minimumFractionDigits:
                        "Número mínimo de dígitos de fracción",
                    ...
                    templateTitleLocation:
                        "Localización del título de pregunta",
                    panelRemoveButtonLocation:
                        "Localización del botón eliminar panel",
                    hideIfRowsEmpty: "Ocultar pregunta si no hay más filas",
                    hideColumnsIfEmpty: "Ocultar columnas si no hay filas",
                    hideIfChoicesEmpty:
                        "Ocultar la pregunta si no contiene opciones",
                    ...
                    columnMinWidth:
                        "Anchura mímima de columna (en valores aceptados CSS)",
                    rowTitleWidth:
                        "Anchura de cabecera de fila (en valores aceptados CSS)",
                    ...
                    separateSpecialChoices:
                        "Opciones de separación especiales (None, Other, Select All)",
                    choicesFromQuestion:
                        "Copiar opciones de la siguiente pregunta",
                    ...
                    panel: { indent: "Añadir indents externos" },
                    innerIndent: "Añadir indents internos",
                    defaultValueFromLastRow:
                        "Tomar valores por defecto de la última fila",
                    defaultValueFromLastPanel:
                        "Tomar valores por defecto del último panel",
                    ...
                    triggerIsVariable:
                        "No coloque la variable en el resultado de la encuesta",
                    triggerRunExpressionEmpty:
                        "Por favor ingrese una expresión válida",
                    emptyExpressionPlaceHolder: "Escribir expresión aquí...",
                    noFile: "Ningún archivo elegido",
                    clearIfInvisible:
                        "Limpiar el valor si la pregunta se oculta",
                ...
                pv: {
                    ...
                    onHiddenContainer:
                        "Cuando la pregunta o su panel/página se oculta",
                    clearInvisibleValues: { none: "Nunca" },
                    all: "todas",
                    page: "página",
                    survey: "encuesta",
                    ...
                    showAllQuestions:
                        "Mostrar vista previa con todas las preguntas",
                    showAnsweredQuestions:
                        "Mostrar vista previa con preguntas contestadas",
                    pages: "páginas",
                    questions: "preguntas",
                    ...
                    underRowSingle:
                        "Debajo de la fila, sólo un panel es visible",
                    showNavigationButtons: { none: "Oculto" },
                    showProgressBar: { off: "Oculto" },
                    showTimerPanel: { none: "Oculto" },
                    showTimerPanelMode: { all: "Ambos" },
                    detailPanelMode: { none: "Oculto" },
                    addRowLocation: {
                        default: "Depende de la disposición de la matriz",
                    },
                    panelsState: {
                        default:
                            "Usuarios no pueden expandir o colapsar paneles",
                        collapsed: "Todos los paneles colapsados",
                        expanded: "Todos los paneles expandidos",
                    },
                    widthMode: { static: "Estático" },
                    imageFit: { none: "Ninguno", contain: "Contiene" },
                    contentMode: { image: "Imagen" },
                    displayMode: { buttons: "Botomes" },
                },
                op: {
                    empty: "esta vacio",
                ...
                p: {
                    ...
                    itemSize: "artículos",
                    navigationButtonsVisibility:
                        "Navegación botones visibilidad",
                    label: "etiqueta",
                },
            };
            i.editorLocalization.locales.sv = {
                survey: {
                    edit: "Redigera",
                    dropQuestion:
                        "Dra och släpp en fråga från Verktygslistan till vänster.",
                    copy: "Kopiera",
                ...
                pe: {
                    ...
                    aceEditorHelp:
                        "Tryck ctrl+mellanslag för att få en ledtråd",
                    ...
                    cellsEmptyRowsColumns:
                        "Det bör vara minst 1 kolumn eller rad",
                    ...
                    cookieName:
                        "Kaknamn (för att inaktivera kör enkäten två gånger lokalt)",
                    sendResultOnPageNext:
                        "Skicka enkät resultatet till nästa sida",
                    storeOthersAsComment:
                        "Lagra 'andra' värden i ett separat fält",
                    ...
                    showNavigationButtons:
                        "Visa navigationsknappar (standard navigering)",
                    showPrevButton:
                        "Visa föregående knapp (användaren kan gå återgå till föregående sida)",
                    firstPageIsStarted:
                        "Den första sidan i enkäten är startsidan.",
                    showCompletedPage:
                        "Visa den slutförda sidan på slutet (completedHtml)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Fråga start index (1, 2 eller 'A', 'a')",
                    ...
                    maxTimeToFinishPage:
                        "Max tid för att göra färdigt en sida i enkäten",
                    page: {},
                    question: {},
                    ...
                    triggerIsVariable:
                        "Var vänligen skriv ett giltigt uttryck.",
                },
                pv: {
                    inherit: "inherit",
                    show: "show",
            ...
            i.editorLocalization.locales.tg = {
                survey: {
                    edit: "Тағйир додан",
                    ...
                    externalHelpLinkUrl:
                        "Https://www.youtube.com/channel/UCH2ru9okIcooNZfpIbyq4qQ?view_as=subscriber",
                    dropQuestion:
                        "Илтимос, элементи даркориро аз бастаи чап кашида биёред.",
                ...
                ed: {
                    ...
                    translationNoStrings:
                        "Сатрҳо барои тарҷума вуҷуд надоранд. Илтимос, филтрро тағйир диҳед.",
                    translationExportToSCVButton: "Экспорт ба CSV",
                    translationImportFromSCVButton: "Импорт аз CSV",
                    translationMergeLocaleWithDefault:
                        "Якҷоя кардани {0} бо локали нобаёнӣ",
                    bold: "Ғавс",
                    italic: "Қаҷ",
                    underline: "Зерхат",
                    ...
                    lg: {
                        ...
                        trigger_copyvalueName:
                            "Нусхабардорӣ кардани қиммати савол",
                        trigger_skipName: "Гузаштан ба савол",
                        trigger_runExpressionName:
                            "Иҷро кардани ифодаи истифодабаранда",
                        completedHtmlOnConditionName:
                            "Матни истифодабаранда 'Саҳифаи ташаккурӣ'",
                        page_visibilityDescription:
                        ...
                        itemExpressionText:
                            "Вақте, ки ифода: '{0}' бармегардонад 'true':",
                        ...
                        trigger_completeText:
                            "Саволнома ҳамчун анҷомшуда тағйир меёбад",
                        trigger_setvalueText:
                            "Ба саволи {0} қиммати {1}-ро сабт кардан",
                        trigger_copyvalueText:
                            "Нусхабардорӣ кардан ба саволи {0} қиммат аз саволи {1}",
                        trigger_skipText: "Саволнома мегузарад ба саволи {0}",
                        trigger_runExpressionText1:
                            "Иҷро кардани ифодаи: '{0}'",
                        trigger_runExpressionText2:
                            "ва натиҷаи онро ба саволи {0} гузоштан",
                        completedHtmlOnConditionText:
                ...
                pe: {
                    ...
                    conditionValueQuestionTitle:
                        "Илтимос, қимматро ворид/интихоб кунед",
                    expressionHelp:
                    ...
                    aceEditorHelp:
                        "Тугмаҳои Ctrl+Пробел пахш кунед, барои гирифтани ишораҳои кӯмакӣ",
                    aceEditorRowTitle: "Сатрҳои ҷорӣ",
                    aceEditorPanelTitle: "Бастаи ҷорӣ",
                    showMore:
                        "Барои гирифтани маълумоти мушаххастар, илтимос, ба дастурамал гузаред",
                    ...
                    propertyNameIsNotUnique:
                        "Лутфан як номи беҳамто ворид кунед",
                    ...
                    selectAllText:
                        "Матни нуқта 'Ҳамаи нуқтаҳоро интихоб кардан'",
                    choicesMin:
                        "Қиммати минималӣ барои элементҳои сохташуда бо роҳи автоматӣ",
                    choicesMax:
                        "Қиммати максималӣ барои элементҳои сохташуда бо роҳи автоматӣ",
                    choicesStep:
                        "Фарқият байни элементҳои сохташуда бо роҳи автоматӣ",
                    name: "Ном",
                    title: "Сарлавҳа",
                    ...
                    isRequired: "Ҳатмӣ?",
                    isAllRowRequired:
                        "Ҳамаи сатрҳо барои пуркунӣ ҳатмӣ мебошад",
                    ...
                    storeDataAsText:
                        "Нигоҳ доштани дохили файл дар формати JSON ҳамчун матн",
                    ...
                    cookieName:
                        "Номи Cookie (куштани такроран локалӣ гузаштани саволнома)",
                    sendResultOnPageNext:
                        "Нишон додани натиҷаи саволнома дар саҳифаи наздик",
                    storeOthersAsComment:
                        "Нигоҳ доштани қиммати 'Дигар' дар майдони алоҳида",
                    ...
                    showNavigationButtons:
                        "Нишон додани тугмаҳои новбарӣ (новбарии нобаён)",
                    showPrevButton:
                        "Нишон додани тугмаи 'Саҳифаи пештара' (истифодабар метавонад ба саҳифаи пештара баргардад)",
                    firstPageIsStarted:
                        "Саҳифаи якуми саволнома саҳифаи саршаванда мебошад.",
                    showCompletedPage:
                        "Нишон додани саҳифа бо матн дар анҷоми пуркунӣ (HTML-и саҳифаи анҷом)",
                    goNextPageAutomatic:
                        "Гузариш ба саҳифаи оянда ба роҳи автоматӣ дар ҳолати пуркунии ҳамаи саволҳо",
                    ...
                    questionStartIndex:
                        "Индекси саршавии савол (1, 2 ё 'A', 'а')",
                    showQuestionNumbers: "Нишон додани номери савол",
                    questionTitleTemplate:
                        "Намунаи номи саволнома, ҳамчун нобаён: {матнро} {талаб} {намекунад}.",
                    questionErrorLocation: "Ҷойгиркунии хатогии саволнома",
                    focusFirstQuestionAutomatic:
                        "Гузариш ба саволи якум дар ивазкунии саҳифа",
                    questionsOrder: "Мураттабсозии элементҳо дар саҳифа",
                    maxTimeToFinish:
                        "Вақти максималӣ дар сонияҳо, барои пур кардани саволнома",
                    maxTimeToFinishPage:
                        "Вақти максималӣ дар сонияҳо, барои пур кардани саҳифаи саволнома",
                    page: {},
                    question: {},
                    ...
                    tabs: {
                        ...
                        multipleTextItems:
                            "Дохилкунии якчанд майдончаҳои матнӣ",
                    ...
                    triggerCompleteText:
                        "Тамом кардани саволнома, агар ҳама иҷро шавад.",
                    ...
                    triggerIsVariable:
                        "Тағйирёбандаро ба натиҷаи саволнома нагузоштан.",
                    triggerRunExpressionEmpty:
                        "Илтимос, қиммати дурустро ворид кунед.",
                },
                pv: {
                ...
                triggers: {
                    ...
                    visibletrigger:
                        "Тағйир кардани намоиш (тавсия дода намешавад)",
                },
                pehelp: { choicesbyurl: {} },
                p: {
                    title: {
                    ...
                    navigationButtonsVisibility:
                        "Нишон додани тугмаҳои новбарӣ",
                    label: "Миёнабур",
                },
            };
            i.editorLocalization.locales["zh-tw"] = {
                survey: {
                    edit: "編輯",
            ...
            i.editorLocalization.locales.tr = {
                survey: {
                    edit: "Düzenle",
                    ...
                    addLogicItem:
                        "Anket akışını özelleştirmek için bir kural oluşturun.",
                    copy: "Kopyala",
                ...
                ed: {
                    ...
                    lg: {
                        ...
                        trigger_runExpressionName:
                            "Varsayılan ifadeyi çalıştır",
                        completedHtmlOnConditionName:
                            "Varyalın 'Teşekkür sayfası' yazısı",
                        page_visibilityDescription:
                        ...
                        itemExpressionText:
                            "Mantıksal ifade: '{0}' geçerli olsun:",
                        ...
                        trigger_copyvalueText:
                            "Sorusundan {1}, {0} değerini, soruya kopyala",
                        trigger_skipText: "Soruya geç {0}",
                        trigger_runExpressionText1:
                            "Mantıksal ifadeyi çalıştır: '{0}'",
                        trigger_runExpressionText2:
                            " ve sonuç değerini soruya ekle: {0}",
                        completedHtmlOnConditionText:
                            "Özel 'Teşekkürler sayfasını' göster.",
                        ...
                        actionInvalid:
                            "Lütfen, Olay(lar)daki sorunları gideriniz.",
                    },
                },
                pe: {
                    apply: "Uygula",
                    ...
                    choicesMin:
                        "Otomatik oluşturulan öğeler için minimum değer",
                    choicesMax:
                        "Otomatik oluşturulan öğeler için maksimum değer",
                    ...
                    storeDataAsText:
                        "Dosya içeriğini JSON sonucunda metin olarak depola",
                    ...
                    sendResultOnPageNext:
                        "Bir sonraki sayfada anket sonuçlarını gönder",
                    storeOthersAsComment:
                        "'Diğerleri' değerini ayrı alanda depolayın",
                    ...
                    showNavigationButtons:
                        "Gezinme butonlarını göster (varsayılan gezinme)",
                    showPrevButton:
                        "Önceki butonu göster (kullanıcı önceki sayfaya dönebilir)",
                    firstPageIsStarted:
                        "Anketteki ilk sayfa bir başlangıç sayfasıdır.",
                    showCompletedPage:
                        "Tamamlanan sayfayı en sonunda göster (HTML)",
                    goNextPageAutomatic:
                    ...
                    questionStartIndex:
                        "Soru indeksi (1, 2 veya 'A', 'a' gibi)",
                ...
                triggers: {
                    ...
                    visibletrigger:
                        "görünürlüğü değiştir (kullanımdan kaldırıldı)",
                },
                pehelp: { choicesbyurl: {} },
                p: {
                    title: {
                    ...
                    useDisplayValuesInDynamicTexts:
                        "Başlıkta görünen değeri kullan",
                    ...
                    itemSize: "Öğe boyutu",
                    navigationButtonsVisibility:
                        "Navigasyon butonları görünürlüğü",
                    label: "Başlık",
